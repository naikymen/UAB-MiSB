...
<!-- generated with COPASI 4.16 (Build 104) (http://www.copasi.org) at 2016-11-25 10:02:06 UTC -->
...
<COPASI xmlns="http://www.copasi.org/static/schema" versionMajor="4" versionMinor="16" versionDevel="104" copasiSourcesModified="0">
  ...
  <Model key="Model_8" name="New Model" simulationType="time" timeUnit="s" volumeUnit="l" areaUnit="m²" lengthUnit="m" quantityUnit="mmol" type="deterministic" avogadroConstant="6.02214179e+23">
    <MiriamAnnotation>
<rdf:RDF
...
El flujo a través de la rama P2 y la entrada de S disminuyen, mientras aumenta el flujo a través de la rama P1.
    ...
    <ListOfMetabolites>
      <Metabolite key="Metabolite_35" name="S" simulationType="fixed" compartment="Compartment_6">
        <MiriamAnnotation>
<rdf:RDF xmlns:dcterms="http://purl.org/dc/terms/" xmlns:rdf="http://www.w3.org/1999/02/22-rdf-syntax-ns#">
  <rdf:Description rdf:about="#Metabolite_35">
    <dcterms:created>
      ...
      <Metabolite key="Metabolite_31" name="X1" simulationType="reactions" compartment="Compartment_6">
        <MiriamAnnotation>
<rdf:RDF xmlns:dcterms="http://purl.org/dc/terms/" xmlns:rdf="http://www.w3.org/1999/02/22-rdf-syntax-ns#">
  <rdf:Description rdf:about="#Metabolite_31">
    <dcterms:created>
      ...
      <Metabolite key="Metabolite_27" name="X2" simulationType="reactions" compartment="Compartment_6">
        <MiriamAnnotation>
<rdf:RDF xmlns:dcterms="http://purl.org/dc/terms/" xmlns:rdf="http://www.w3.org/1999/02/22-rdf-syntax-ns#">
  <rdf:Description rdf:about="#Metabolite_27">
    <dcterms:created>
      ...
      <Metabolite key="Metabolite_7" name="X3" simulationType="reactions" compartment="Compartment_6">
        <MiriamAnnotation>
<rdf:RDF xmlns:dcterms="http://purl.org/dc/terms/" xmlns:rdf="http://www.w3.org/1999/02/22-rdf-syntax-ns#">
  <rdf:Description rdf:about="#Metabolite_7">
    <dcterms:created>
      ...
      <Metabolite key="Metabolite_15" name="X4" simulationType="reactions" compartment="Compartment_6">
        <MiriamAnnotation>
<rdf:RDF xmlns:dcterms="http://purl.org/dc/terms/" xmlns:rdf="http://www.w3.org/1999/02/22-rdf-syntax-ns#">
  <rdf:Description rdf:about="#Metabolite_15">
    <dcterms:created>
      ...
      <Metabolite key="Metabolite_58" name="X5" simulationType="reactions" compartment="Compartment_6">
        <MiriamAnnotation>
<rdf:RDF xmlns:dcterms="http://purl.org/dc/terms/" xmlns:rdf="http://www.w3.org/1999/02/22-rdf-syntax-ns#">
  <rdf:Description rdf:about="#Metabolite_58">
    <dcterms:created>
      ...
      <Metabolite key="Metabolite_60" name="X6" simulationType="reactions" compartment="Compartment_6">
        <MiriamAnnotation>
<rdf:RDF xmlns:dcterms="http://purl.org/dc/terms/" xmlns:rdf="http://www.w3.org/1999/02/22-rdf-syntax-ns#">
  <rdf:Description rdf:about="#Metabolite_60">
    <dcterms:created>
      ...
      <Metabolite key="Metabolite_62" name="P1" simulationType="fixed" compartment="Compartment_6">
        <MiriamAnnotation>
<rdf:RDF xmlns:dcterms="http://purl.org/dc/terms/" xmlns:rdf="http://www.w3.org/1999/02/22-rdf-syntax-ns#">
  <rdf:Description rdf:about="#Metabolite_62">
    <dcterms:created>
      ...
      <Metabolite key="Metabolite_64" name="P2" simulationType="fixed" compartment="Compartment_6">
        <MiriamAnnotation>
<rdf:RDF
   xmlns:dcterms="http://purl.org/dc/terms/"
   xmlns:rdf="http://www.w3.org/1999/02/22-rdf-syntax-ns#">
  <rdf:Description rdf:about="#Metabolite_64">
    <dcterms:created>
      ...
      <Metabolite key="Metabolite_66" name="A" simulationType="reactions" compartment="Compartment_6">
        <MiriamAnnotation>
<rdf:RDF xmlns:dcterms="http://purl.org/dc/terms/" xmlns:rdf="http://www.w3.org/1999/02/22-rdf-syntax-ns#">
  <rdf:Description rdf:about="#Metabolite_66">
    <dcterms:created>
      ...
      <Metabolite key="Metabolite_68" name="AH" simulationType="reactions" compartment="Compartment_6">
        <MiriamAnnotation>
<rdf:RDF xmlns:dcterms="http://purl.org/dc/terms/" xmlns:rdf="http://www.w3.org/1999/02/22-rdf-syntax-ns#">
  ...
  <rdf:Description rdf:about="#Reaction_0">
    <dcterms:created>
      <rdf:Description>
        ...
        <ListOfConstants>
          <Constant key="Parameter_4273" name="Vf" value="10"/>
          <Constant key="Parameter_4274" name="Keq" value="1"/>
          <Constant key="Parameter_4045" name="Shalve" value="1"/>
          <Constant key="Parameter_4046" name="Phalve" value="1"/>
          <Constant key="Parameter_4047" name="h" value="4"/>
          <Constant key="Parameter_4048" name="Mhalve" value="1"/>
          <Constant key="Parameter_4049" name="alpha" value="0.1"/>
        </ListOfConstants>
  ...
  <rdf:Description rdf:about="#Reaction_1">
    <dcterms:created>
      <rdf:Description>
        ...
        <ListOfConstants>
          <Constant key="Parameter_4050" name="Keq" value="1"/>
          <Constant key="Parameter_4051" name="Vf" value="10"/>
          <Constant key="Parameter_4052" name="Vr" value="10"/>
          <Constant key="Parameter_4053" name="Kma" value="1"/>
          <Constant key="Parameter_4054" name="Kmb" value="1"/>
          <Constant key="Parameter_4055" name="Kmp" value="1"/>
          <Constant key="Parameter_4056" name="Kmq" value="1"/>
          <Constant key="Parameter_4057" name="Kia" value="1"/>
          <Constant key="Parameter_4058" name="Kib" value="1"/>
          <Constant key="Parameter_4059" name="Kip" value="1"/>
        </ListOfConstants>
  ...
  <rdf:Description rdf:about="#Reaction_2">
    <dcterms:created>
      <rdf:Description>
        ...
        <ListOfConstants>
          <Constant key="Parameter_4060" name="Vf" value="10"/>
          <Constant key="Parameter_4061" name="Keq" value="1"/>
          <Constant key="Parameter_4062" name="Shalve" value="1"/>
          <Constant key="Parameter_4063" name="Phalve" value="1"/>
          <Constant key="Parameter_4064" name="h" value="4"/>
          <Constant key="Parameter_4065" name="Mhalve" value="1"/>
          <Constant key="Parameter_4066" name="alpha" value="0.1"/>
        </ListOfConstants>
        <KineticLaw function="Function_25">
          <ListOfCallParameters>
            <CallParameter functionParameter="FunctionParameter_179">
  ...
  <rdf:Description rdf:about="#Reaction_3">
    <dcterms:created>
      <rdf:Description>
        ...
        <ListOfConstants>
          <Constant key="Parameter_4067" name="Kmp" value="1"/>
          <Constant key="Parameter_4068" name="Vf" value="10"/>
          <Constant key="Parameter_4069" name="Keq" value="1"/>
          <Constant key="Parameter_4070" name="Vr" value="10"/>
          <Constant key="Parameter_4071" name="Kma" value="1"/>
          <Constant key="Parameter_4197" name="Kmb" value="1"/>
          <Constant key="Parameter_4196" name="Kmq" value="1"/>
          <Constant key="Parameter_4195" name="Kia" value="1"/>
          <Constant key="Parameter_4395" name="Kib" value="1"/>
          <Constant key="Parameter_4396" name="Kip" value="1"/>
        </ListOfConstants>
        <KineticLaw function="Function_21">
          <ListOfCallParameters>
            <CallParameter functionParameter="FunctionParameter_127">
  ...
  <rdf:Description rdf:about="#Reaction_4">
    <dcterms:created>
      <rdf:Description>
        ...
        <ListOfConstants>
          <Constant key="Parameter_4397" name="Kms" value="1"/>
          <Constant key="Parameter_4398" name="Kmp" value="1"/>
          <Constant key="Parameter_4399" name="Vf" value="10"/>
          <Constant key="Parameter_4400" name="Keq" value="1"/>
        </ListOfConstants>
  ...
  <rdf:Description rdf:about="#Reaction_5">
    <dcterms:created>
      <rdf:Description>
        ...
        <ListOfConstants>
          <Constant key="Parameter_4401" name="Vf" value="10"/>
          <Constant key="Parameter_4402" name="Keq" value="1"/>
          <Constant key="Parameter_4403" name="Shalve" value="1"/>
          <Constant key="Parameter_4404" name="Phalve" value="1"/>
          <Constant key="Parameter_4405" name="h" value="4"/>
          <Constant key="Parameter_4406" name="Mhalve" value="1"/>
          <Constant key="Parameter_4407" name="alpha" value="0.1"/>
        </ListOfConstants>
        <KineticLaw function="Function_25">
          <ListOfCallParameters>
            <CallParameter functionParameter="FunctionParameter_179">
  ...
  <rdf:Description rdf:about="#Reaction_6">
    <dcterms:created>
      <rdf:Description>
        ...
        <ListOfConstants>
          <Constant key="Parameter_4408" name="Kmp" value="1"/>
          <Constant key="Parameter_4269" name="Vf" value="10"/>
          <Constant key="Parameter_4270" name="Keq" value="1"/>
          <Constant key="Parameter_4271" name="Vr" value="10"/>
          <Constant key="Parameter_4272" name="Kma" value="1"/>
          <Constant key="Parameter_4218" name="Kmb" value="1"/>
          <Constant key="Parameter_4219" name="Kmq" value="1"/>
          <Constant key="Parameter_4217" name="Kia" value="1"/>
          <Constant key="Parameter_4216" name="Kib" value="1"/>
          <Constant key="Parameter_4215" name="Kip" value="1"/>
        </ListOfConstants>
        <KineticLaw function="Function_21">
          <ListOfCallParameters>
            <CallParameter functionParameter="FunctionParameter_127">
  ...
  <rdf:Description rdf:about="#Reaction_7">
    <dcterms:created>
      <rdf:Description>
        ...
        <ListOfConstants>
          <Constant key="Parameter_4214" name="Kms" value="1"/>
          <Constant key="Parameter_4213" name="Kmp" value="1"/>
          <Constant key="Parameter_4212" name="Vf" value="10"/>
          <Constant key="Parameter_4211" name="Keq" value="1"/>
        </ListOfConstants>
        <KineticLaw function="Function_36">
          <ListOfCallParameters>
            <CallParameter functionParameter="FunctionParameter_252">
    ...
    <ListOfModelParameterSets activeSet="ModelParameterSet_0">
      <ModelParameterSet key="ModelParameterSet_0" name="Initial State">
        ...
        <ModelParameterGroup cn="String=Initial Species Values" type="Group">
          ...
          <ModelParameter cn="CN=Root,Model=New Model,Vector=Compartments[compartment],Vector=Metabolites[P2]" value="1.204428358e+20" type="Species" simulationType="fixed"/>
        ...
        <ModelParameterGroup cn="String=Initial Global Quantities" type="Group">
          ...
          <ModelParameter cn="CN=Root,Model=New Model,Vector=Values[MAR8]" value="0.2" type="ModelValue" simulationType="assignment"/>
    ...
    <InitialState type="initialState">
      0 1.204428358e+20 3.011070895000001e+19 6.022141790000001e+20 6.022141790000001e+20 6.022141790000001e+20 6.022141790000001e+20 6.022141790000001e+20 3.011070895000001e+19 1 0.2 5 1 0.1 5 1 0.2 6.022141790000001e+20 6.022141790000001e+19 1.204428358e+20 1 1 10 4 0.1 1 10 
    </InitialState>
  </Model>
  <ListOfTasks>
