...
<!-- generated with COPASI 4.16 (Build 104) (http://www.copasi.org) at 2016-12-02 16:36:25 UTC -->
...
<rdf:RDF xmlns:dcterms="http://purl.org/dc/terms/" xmlns:rdf="http://www.w3.org/1999/02/22-rdf-syntax-ns#">
  ...
  <Model key="Model_8" name="Repressilator MiSB" simulationType="time" timeUnit="min" volumeUnit="fl" areaUnit="m²" lengthUnit="m" quantityUnit="#" type="deterministic" avogadroConstant="6.02214179e+23">
    <MiriamAnnotation>
<rdf:RDF
  ...
  <rdf:Description rdf:about="#Model_8">
    ...
    <Comment>
      volviendo a n = 2
Las oscilaciones se acercan más al modelo determinista, pero las oscilaciones no son regulares.
Le diagrama de fase muestra las curvas del atractor, pero las orbitas son muy variables.
    </Comment>
    <ListOfCompartments>
    ...
    <ListOfMetabolites>
      <Metabolite key="Metabolite_27" name="cI-mRNA" simulationType="reactions" compartment="Compartment_6">
        <MiriamAnnotation>
<rdf:RDF xmlns:dcterms="http://purl.org/dc/terms/" xmlns:rdf="http://www.w3.org/1999/02/22-rdf-syntax-ns#">
  <rdf:Description rdf:about="#Metabolite_27">
    <dcterms:created>
      ...
      <Metabolite key="Metabolite_1" name="cI-proteina" simulationType="reactions" compartment="Compartment_6">
      </Metabolite>
      <Metabolite key="Metabolite_9" name="TetR-mRNA" simulationType="reactions" compartment="Compartment_6">
        <MiriamAnnotation>
<rdf:RDF xmlns:dcterms="http://purl.org/dc/terms/" xmlns:rdf="http://www.w3.org/1999/02/22-rdf-syntax-ns#">
  <rdf:Description rdf:about="#Metabolite_9">
    <dcterms:created>
      ...
      <Metabolite key="Metabolite_37" name="TetR-proteina" simulationType="reactions" compartment="Compartment_6">
        <MiriamAnnotation>
<rdf:RDF xmlns:dcterms="http://purl.org/dc/terms/" xmlns:rdf="http://www.w3.org/1999/02/22-rdf-syntax-ns#">
  <rdf:Description rdf:about="#Metabolite_37">
    <dcterms:created>
      ...
      <Metabolite key="Metabolite_39" name="LacI-mRNA" simulationType="reactions" compartment="Compartment_6">
      </Metabolite>
      <Metabolite key="Metabolite_41" name="LacI-proteina" simulationType="reactions" compartment="Compartment_6">
      </Metabolite>
    </ListOfMetabolites>
    <ListOfModelValues>
  ...
  <rdf:Description rdf:about="#Reaction_0">
    <dcterms:created>
      <rdf:Description>
        ...
        <ListOfConstants>
          <Constant key="Parameter_4197" name="k" value="6.93147"/>
        </ListOfConstants>
  ...
  <rdf:Description rdf:about="#Reaction_1">
    <dcterms:created>
      <rdf:Description>
        ...
        <ListOfConstants>
          <Constant key="Parameter_4198" name="k1" value="0.346574"/>
        </ListOfConstants>
  ...
  <rdf:Description rdf:about="#Reaction_2">
    <dcterms:created>
      <rdf:Description>
        ...
        <ListOfConstants>
          <Constant key="Parameter_4188" name="k1" value="0.0693147"/>
        </ListOfConstants>
        <KineticLaw function="Function_13">
          <ListOfCallParameters>
            <CallParameter functionParameter="FunctionParameter_81">
  ...
  <rdf:Description rdf:about="#Reaction_3">
    <dcterms:created>
      <rdf:Description>
        ...
        <ListOfConstants>
          <Constant key="Parameter_4189" name="amintr" value="0.216404"/>
          <Constant key="Parameter_4190" name="adeltatr" value="216.188"/>
          <Constant key="Parameter_4191" name="KM" value="40"/>
          <Constant key="Parameter_4192" name="n" value="2"/>
        </ListOfConstants>
  ...
  <rdf:Description rdf:about="#Reaction_4">
    <dcterms:created>
      <rdf:Description>
        ...
        <ListOfConstants>
          <Constant key="Parameter_4193" name="k" value="6.93147"/>
        </ListOfConstants>
        <KineticLaw function="Function_41">
          <ListOfCallParameters>
            <CallParameter functionParameter="FunctionParameter_271">
  ...
  <rdf:Description rdf:about="#Reaction_5">
    <dcterms:created>
      <rdf:Description>
        ...
        <ListOfConstants>
          <Constant key="Parameter_4194" name="k1" value="0.346574"/>
        </ListOfConstants>
        <KineticLaw function="Function_13">
          <ListOfCallParameters>
            <CallParameter functionParameter="FunctionParameter_81">
  ...
  <rdf:Description rdf:about="#Reaction_6">
    <dcterms:created>
      <rdf:Description>
        ...
        <ListOfConstants>
          <Constant key="Parameter_4401" name="k1" value="0.0693147"/>
        </ListOfConstants>
        <KineticLaw function="Function_13">
          <ListOfCallParameters>
            <CallParameter functionParameter="FunctionParameter_81">
  ...
  <rdf:Description rdf:about="#Reaction_7">
    <dcterms:created>
      <rdf:Description>
        ...
        <ListOfConstants>
          <Constant key="Parameter_4402" name="amintr" value="0.216404"/>
          <Constant key="Parameter_4066" name="adeltatr" value="216.188"/>
          <Constant key="Parameter_4067" name="KM" value="40"/>
          <Constant key="Parameter_4068" name="n" value="2"/>
        </ListOfConstants>
        <KineticLaw function="Function_40">
          <ListOfCallParameters>
            <CallParameter functionParameter="FunctionParameter_264">
  ...
  <rdf:Description rdf:about="#Reaction_8">
    <dcterms:created>
      <rdf:Description>
        ...
        <ListOfConstants>
          <Constant key="Parameter_4069" name="k" value="6.93147"/>
        </ListOfConstants>
        <KineticLaw function="Function_41">
          <ListOfCallParameters>
            <CallParameter functionParameter="FunctionParameter_271">
  ...
  <rdf:Description rdf:about="#Reaction_9">
    <dcterms:created>
      <rdf:Description>
        ...
        <ListOfConstants>
          <Constant key="Parameter_4070" name="k1" value="0.346574"/>
        </ListOfConstants>
        <KineticLaw function="Function_13">
          <ListOfCallParameters>
            <CallParameter functionParameter="FunctionParameter_81">
  ...
  <rdf:Description rdf:about="#Reaction_10">
    <dcterms:created>
      <rdf:Description>
        ...
        <ListOfConstants>
          <Constant key="Parameter_4071" name="k1" value="0.0693147"/>
        </ListOfConstants>
        <KineticLaw function="Function_13">
          <ListOfCallParameters>
            <CallParameter functionParameter="FunctionParameter_81">
...
<rdf:RDF xmlns:dcterms="http://purl.org/dc/terms/" xmlns:rdf="http://www.w3.org/1999/02/22-rdf-syntax-ns#">
  <rdf:Description rdf:about="#Reaction_11">
    <dcterms:created>
      <rdf:Description>
        ...
        <ListOfConstants>
          <Constant key="Parameter_4398" name="amintr" value="0.216404"/>
          <Constant key="Parameter_4399" name="adeltatr" value="216.188"/>
          <Constant key="Parameter_4400" name="KM" value="40"/>
          <Constant key="Parameter_4412" name="n" value="2"/>
        </ListOfConstants>
        <KineticLaw function="Function_40">
          <ListOfCallParameters>
            <CallParameter functionParameter="FunctionParameter_264">
  ...
  <SBMLReference file="Ej4 - RepressilatorSMBL.xml">
    ...
    <SBMLMap SBMLid="LacI_mRNA" COPASIkey="Metabolite_39"/>
    <SBMLMap SBMLid="LacI_proteina" COPASIkey="Metabolite_41"/>
    <SBMLMap SBMLid="Pr_hl" COPASIkey="ModelValue_2"/>
    <SBMLMap SBMLid="TetR_mRNA" COPASIkey="Metabolite_9"/>
    <SBMLMap SBMLid="TetR_proteina" COPASIkey="Metabolite_37"/>
    ...
    <SBMLMap SBMLid="cI_mRNA" COPASIkey="Metabolite_27"/>
    <SBMLMap SBMLid="cI_proteina" COPASIkey="Metabolite_1"/>
