...
<!-- generated with COPASI 4.16 (Build 104) (http://www.copasi.org) at 2016-12-02 15:16:57 UTC -->
...
Reaction scheme where the products are created from the reactants and the change of a product quantity is proportional to the product of reactant activities. The reaction scheme does not include any reverse process that creates the reactants from the products. The change of a product quantity is proportional to the quantity of one reactant.
  ...
  <Model key="Model_7" name="Repressilator MiSB" simulationType="time" timeUnit="s" volumeUnit="ml" areaUnit="m²" lengthUnit="m" quantityUnit="mmol" type="deterministic" avogadroConstant="6.02214179e+23">
    <MiriamAnnotation>
<rdf:RDF
  ...
  <rdf:Description rdf:about="#Model_7">
    ...
    <ListOfMetabolites>
      ...
      <Metabolite key="Metabolite_6" name="TetR-mRNA" simulationType="reactions" compartment="Compartment_1">
        <MiriamAnnotation>
<rdf:RDF
   xmlns:dcterms="http://purl.org/dc/terms/"
   xmlns:rdf="http://www.w3.org/1999/02/22-rdf-syntax-ns#">
  <rdf:Description rdf:about="#Metabolite_6">
    <dcterms:created>
      ...
      <Metabolite key="Metabolite_8" name="TetR-proteina" simulationType="reactions" compartment="Compartment_1">
        <MiriamAnnotation>
<rdf:RDF
   xmlns:dcterms="http://purl.org/dc/terms/"
   xmlns:rdf="http://www.w3.org/1999/02/22-rdf-syntax-ns#">
  <rdf:Description rdf:about="#Metabolite_8">
    <dcterms:created>
      ...
      <Metabolite key="Metabolite_10" name="LacI-mRNA" simulationType="reactions" compartment="Compartment_1">
      </Metabolite>
      <Metabolite key="Metabolite_14" name="LacI-proteina" simulationType="reactions" compartment="Compartment_1">
      </Metabolite>
    </ListOfMetabolites>
    <ListOfModelValues>
...
<rdf:RDF
  ...
  <rdf:Description rdf:about="#ModelValue_7">
    <dcterms:created>
      ...
      <ModelValue key="ModelValue_17" name="Adelta" simulationType="assignment">
        <MiriamAnnotation>
<rdf:RDF
   xmlns:dcterms="http://purl.org/dc/terms/"
   xmlns:rdf="http://www.w3.org/1999/02/22-rdf-syntax-ns#">
  <rdf:Description rdf:about="#ModelValue_17">
    <dcterms:created>
      ...
      <ModelValue key="ModelValue_16" name="Alfa_min_tr" simulationType="assignment">
        <MiriamAnnotation>
<rdf:RDF
   xmlns:dcterms="http://purl.org/dc/terms/"
   xmlns:rdf="http://www.w3.org/1999/02/22-rdf-syntax-ns#">
  <rdf:Description rdf:about="#ModelValue_16">
    <dcterms:created>
      ...
      <ModelValue key="ModelValue_15" name="Alfa_delta_tr" simulationType="assignment">
        <MiriamAnnotation>
<rdf:RDF
   xmlns:dcterms="http://purl.org/dc/terms/"
   xmlns:rdf="http://www.w3.org/1999/02/22-rdf-syntax-ns#">
  <rdf:Description rdf:about="#ModelValue_15">
    <dcterms:created>
      ...
      <ModelValue key="ModelValue_14" name="kd_pr" simulationType="assignment">
        <MiriamAnnotation>
<rdf:RDF
   xmlns:dcterms="http://purl.org/dc/terms/"
   xmlns:rdf="http://www.w3.org/1999/02/22-rdf-syntax-ns#">
...
<rdf:RDF
  ...
  <rdf:Description rdf:about="#ModelValue_13">
    <dcterms:created>
      ...
      <ModelValue key="ModelValue_12" name="kd_mRNA" simulationType="assignment">
        <MiriamAnnotation>
<rdf:RDF
   xmlns:dcterms="http://purl.org/dc/terms/"
   xmlns:rdf="http://www.w3.org/1999/02/22-rdf-syntax-ns#">
  <rdf:Description rdf:about="#ModelValue_12">
    ...
    <ListOfReactions>
      <Reaction key="Reaction_0" name="make-cl-m" reversible="false" fast="false">
        <ListOfProducts>
      ...
      <Reaction key="Reaction_1" name="make-cl-p" reversible="false" fast="false">
        <MiriamAnnotation>
<rdf:RDF
   xmlns:dcterms="http://purl.org/dc/terms/"
   xmlns:rdf="http://www.w3.org/1999/02/22-rdf-syntax-ns#">
  <rdf:Description rdf:about="#Reaction_1">
    <dcterms:created>
      <rdf:Description>
        ...
        <ListOfConstants>
          <Constant key="Parameter_4396" name="v" value="0.1"/>
        </ListOfConstants>
        <KineticLaw function="Function_6">
          <ListOfCallParameters>
            <CallParameter functionParameter="FunctionParameter_49">
      ...
      <Reaction key="Reaction_2" name="rm-cl-m" reversible="false" fast="false">
        <ListOfSubstrates>
      ...
      <Reaction key="Reaction_3" name="rm-cl-p" reversible="false" fast="false">
        <ListOfSubstrates>
          <Substrate metabolite="Metabolite_3" stoichiometry="1"/>
        </ListOfSubstrates>
        <ListOfConstants>
          <Constant key="Parameter_4398" name="k1" value="0.1"/>
        </ListOfConstants>
        <KineticLaw function="Function_13">
          <ListOfCallParameters>
            <CallParameter functionParameter="FunctionParameter_81">
      ...
      <Reaction key="Reaction_4" name="make-TetR-m" reversible="false" fast="false">
        <ListOfProducts>
          <Product metabolite="Metabolite_6" stoichiometry="1"/>
        </ListOfProducts>
        <ListOfConstants>
          <Constant key="Parameter_4399" name="v" value="0.1"/>
        </ListOfConstants>
        <KineticLaw function="Function_6">
          <ListOfCallParameters>
            <CallParameter functionParameter="FunctionParameter_49">
      ...
      <Reaction key="Reaction_5" name="make-TetR-p" reversible="false" fast="false">
        <ListOfProducts>
          <Product metabolite="Metabolite_8" stoichiometry="1"/>
        </ListOfProducts>
        <ListOfConstants>
          <Constant key="Parameter_4400" name="v" value="0.1"/>
        </ListOfConstants>
        <KineticLaw function="Function_6">
          <ListOfCallParameters>
            <CallParameter functionParameter="FunctionParameter_49">
      ...
      <Reaction key="Reaction_6" name="rm-TetR-m" reversible="false" fast="false">
        <ListOfSubstrates>
      ...
      <Reaction key="Reaction_7" name="rm-TetR-p" reversible="false" fast="false">
        <ListOfSubstrates>
      ...
      <Reaction key="Reaction_8" name="make-LacI-m" reversible="false" fast="false">
        <ListOfSubstrates>
          <Substrate metabolite="Metabolite_10" stoichiometry="1"/>
        </ListOfSubstrates>
        <ListOfConstants>
          <Constant key="Parameter_4404" name="k1" value="0.1"/>
        </ListOfConstants>
        <KineticLaw function="Function_13">
          <ListOfCallParameters>
            <CallParameter functionParameter="FunctionParameter_81">
      ...
      <Reaction key="Reaction_9" name="make-LacI-p" reversible="false" fast="false">
        <ListOfSubstrates>
      ...
      <Reaction key="Reaction_10" name="rm-LacI-m" reversible="false" fast="false">
        <ListOfProducts>
          <Product metabolite="Metabolite_10" stoichiometry="1"/>
        </ListOfProducts>
        <ListOfConstants>
          <Constant key="Parameter_4406" name="v" value="0.1"/>
        </ListOfConstants>
        <KineticLaw function="Function_6">
          <ListOfCallParameters>
            <CallParameter functionParameter="FunctionParameter_49">
      ...
      <Reaction key="Reaction_11" name="rm-LacI-p" reversible="false" fast="false">
        <ListOfProducts>
          <Product metabolite="Metabolite_14" stoichiometry="1"/>
        </ListOfProducts>
        <ListOfConstants>
          <Constant key="Parameter_4407" name="v" value="0.1"/>
        </ListOfConstants>
        <KineticLaw function="Function_6">
          <ListOfCallParameters>
            <CallParameter functionParameter="FunctionParameter_49">
    ...
    <ListOfModelParameterSets activeSet="ModelParameterSet_1">
      <ModelParameterSet key="ModelParameterSet_1" name="Initial State">
        ...
        <ModelParameterGroup cn="String=Initial Species Values" type="Group">
          <ModelParameter cn="CN=Root,Model=Repressilator MiSB,Vector=Compartments[compartment],Vector=Metabolites[cI-mRNA]" value="6.022141790000001e+20" type="Species" simulationType="reactions"/>
          <ModelParameter cn="CN=Root,Model=Repressilator MiSB,Vector=Compartments[compartment],Vector=Metabolites[cI-proteina]" value="6.022141790000001e+20" type="Species" simulationType="reactions"/>
          <ModelParameter cn="CN=Root,Model=Repressilator MiSB,Vector=Compartments[compartment],Vector=Metabolites[TetR-mRNA]" value="6.022141790000001e+20" type="Species" simulationType="reactions"/>
          <ModelParameter cn="CN=Root,Model=Repressilator MiSB,Vector=Compartments[compartment],Vector=Metabolites[TetR-proteina]" value="6.022141790000001e+20" type="Species" simulationType="reactions"/>
          <ModelParameter cn="CN=Root,Model=Repressilator MiSB,Vector=Compartments[compartment],Vector=Metabolites[LacI-mRNA]" value="6.022141790000001e+20" type="Species" simulationType="reactions"/>
          <ModelParameter cn="CN=Root,Model=Repressilator MiSB,Vector=Compartments[compartment],Vector=Metabolites[LacI-proteina]" value="6.022141790000001e+20" type="Species" simulationType="reactions"/>
        </ModelParameterGroup>
        ...
        <ModelParameterGroup cn="String=Kinetic Parameters" type="Group">
          <ModelParameterGroup cn="CN=Root,Model=Repressilator MiSB,Vector=Reactions[make-cl-m]" type="Reaction">
            <ModelParameter cn="CN=Root,Model=Repressilator MiSB,Vector=Reactions[make-cl-m],ParameterGroup=Parameters,Parameter=v" value="0.1" type="ReactionParameter" simulationType="fixed"/>
          </ModelParameterGroup>
          <ModelParameterGroup cn="CN=Root,Model=Repressilator MiSB,Vector=Reactions[make-cl-p]" type="Reaction">
            <ModelParameter cn="CN=Root,Model=Repressilator MiSB,Vector=Reactions[make-cl-p],ParameterGroup=Parameters,Parameter=v" value="0.1" type="ReactionParameter" simulationType="fixed"/>
          </ModelParameterGroup>
          <ModelParameterGroup cn="CN=Root,Model=Repressilator MiSB,Vector=Reactions[rm-cl-m]" type="Reaction">
            <ModelParameter cn="CN=Root,Model=Repressilator MiSB,Vector=Reactions[rm-cl-m],ParameterGroup=Parameters,Parameter=k1" value="0.1" type="ReactionParameter" simulationType="fixed"/>
          </ModelParameterGroup>
          <ModelParameterGroup cn="CN=Root,Model=Repressilator MiSB,Vector=Reactions[rm-cl-p]" type="Reaction">
            <ModelParameter cn="CN=Root,Model=Repressilator MiSB,Vector=Reactions[rm-cl-p],ParameterGroup=Parameters,Parameter=k1" value="0.1" type="ReactionParameter" simulationType="fixed"/>
          </ModelParameterGroup>
          <ModelParameterGroup cn="CN=Root,Model=Repressilator MiSB,Vector=Reactions[make-TetR-m]" type="Reaction">
            <ModelParameter cn="CN=Root,Model=Repressilator MiSB,Vector=Reactions[make-TetR-m],ParameterGroup=Parameters,Parameter=v" value="0.1" type="ReactionParameter" simulationType="fixed"/>
          </ModelParameterGroup>
          <ModelParameterGroup cn="CN=Root,Model=Repressilator MiSB,Vector=Reactions[make-TetR-p]" type="Reaction">
            <ModelParameter cn="CN=Root,Model=Repressilator MiSB,Vector=Reactions[make-TetR-p],ParameterGroup=Parameters,Parameter=v" value="0.1" type="ReactionParameter" simulationType="fixed"/>
          </ModelParameterGroup>
          <ModelParameterGroup cn="CN=Root,Model=Repressilator MiSB,Vector=Reactions[rm-TetR-m]" type="Reaction">
            <ModelParameter cn="CN=Root,Model=Repressilator MiSB,Vector=Reactions[rm-TetR-m],ParameterGroup=Parameters,Parameter=k1" value="0.1" type="ReactionParameter" simulationType="fixed"/>
          </ModelParameterGroup>
          <ModelParameterGroup cn="CN=Root,Model=Repressilator MiSB,Vector=Reactions[rm-TetR-p]" type="Reaction">
            <ModelParameter cn="CN=Root,Model=Repressilator MiSB,Vector=Reactions[rm-TetR-p],ParameterGroup=Parameters,Parameter=k1" value="0.1" type="ReactionParameter" simulationType="fixed"/>
          </ModelParameterGroup>
          <ModelParameterGroup cn="CN=Root,Model=Repressilator MiSB,Vector=Reactions[make-LacI-m]" type="Reaction">
            <ModelParameter cn="CN=Root,Model=Repressilator MiSB,Vector=Reactions[make-LacI-m],ParameterGroup=Parameters,Parameter=k1" value="0.1" type="ReactionParameter" simulationType="fixed"/>
          </ModelParameterGroup>
          <ModelParameterGroup cn="CN=Root,Model=Repressilator MiSB,Vector=Reactions[make-LacI-p]" type="Reaction">
            <ModelParameter cn="CN=Root,Model=Repressilator MiSB,Vector=Reactions[make-LacI-p],ParameterGroup=Parameters,Parameter=k1" value="0.1" type="ReactionParameter" simulationType="fixed"/>
          </ModelParameterGroup>
          <ModelParameterGroup cn="CN=Root,Model=Repressilator MiSB,Vector=Reactions[rm-LacI-m]" type="Reaction">
            <ModelParameter cn="CN=Root,Model=Repressilator MiSB,Vector=Reactions[rm-LacI-m],ParameterGroup=Parameters,Parameter=v" value="0.1" type="ReactionParameter" simulationType="fixed"/>
          </ModelParameterGroup>
          <ModelParameterGroup cn="CN=Root,Model=Repressilator MiSB,Vector=Reactions[rm-LacI-p]" type="Reaction">
            <ModelParameter cn="CN=Root,Model=Repressilator MiSB,Vector=Reactions[rm-LacI-p],ParameterGroup=Parameters,Parameter=v" value="0.1" type="ReactionParameter" simulationType="fixed"/>
          </ModelParameterGroup>
        </ModelParameterGroup>
      </ModelParameterSet>
    ...
    <InitialState type="initialState">
      0 6.022141790000001e+20 6.022141790000001e+20 6.022141790000001e+20 6.022141790000001e+20 6.022141790000001e+20 6.022141790000001e+20 0.03 29.97 0.2164042561333445 216.1878518772112 0.06931471805599453 0.2 0.3465735902799726 1 0.0005 0.5 10 2 20 40 2 
    </InitialState>
  </Model>
  <ListOfTasks>
  ...
  <SBMLReference file="Represillator.xml">
    <SBMLMap SBMLid="Constant_flux__irreversible" COPASIkey="Function_6"/>
    <SBMLMap SBMLid="LacI_mRNA" COPASIkey="Metabolite_10"/>
    <SBMLMap SBMLid="LacI_proteina" COPASIkey="Metabolite_14"/>
    <SBMLMap SBMLid="TetR_mRNA" COPASIkey="Metabolite_6"/>
    <SBMLMap SBMLid="TetR_proteina" COPASIkey="Metabolite_8"/>
    <SBMLMap SBMLid="cI_mRNA" COPASIkey="Metabolite_1"/>
    <SBMLMap SBMLid="cI_proteina" COPASIkey="Metabolite_3"/>
    <SBMLMap SBMLid="compartment" COPASIkey="Compartment_1"/>
    <SBMLMap SBMLid="make_LacI_p" COPASIkey="Reaction_9"/>
    <SBMLMap SBMLid="make_TetR_m" COPASIkey="Reaction_4"/>
    <SBMLMap SBMLid="make_TetR_p" COPASIkey="Reaction_5"/>
    <SBMLMap SBMLid="make_cl_m" COPASIkey="Reaction_0"/>
    <SBMLMap SBMLid="make_cl_p" COPASIkey="Reaction_1"/>
    <SBMLMap SBMLid="reaction_8" COPASIkey="Reaction_8"/>
    <SBMLMap SBMLid="rm_LacI_m" COPASIkey="Reaction_10"/>
    <SBMLMap SBMLid="rm_LacI_p" COPASIkey="Reaction_11"/>
    <SBMLMap SBMLid="rm_TetR_m" COPASIkey="Reaction_6"/>
    <SBMLMap SBMLid="rm_TetR_p" COPASIkey="Reaction_7"/>
    <SBMLMap SBMLid="rm_cl_m" COPASIkey="Reaction_2"/>
    <SBMLMap SBMLid="rm_cl_p" COPASIkey="Reaction_3"/>
  </SBMLReference>
</COPASI>
