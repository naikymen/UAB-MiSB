...
<!-- generated with COPASI 4.16 (Build 104) (http://www.copasi.org) at 2016-12-02 15:31:07 UTC -->
...
<rdf:RDF
  ...
  <rdf:Description rdf:about="#ModelValue_12">
    <dcterms:created>
      ...
      <ModelValue key="ModelValue_11" name="mRNA_tv" simulationType="assignment">
        <MiriamAnnotation>
<rdf:RDF
   xmlns:dcterms="http://purl.org/dc/terms/"
   xmlns:rdf="http://www.w3.org/1999/02/22-rdf-syntax-ns#">
  <rdf:Description rdf:about="#ModelValue_11">
    <dcterms:created>
      ...
      <ModelValue key="ModelValue_10" name="k_tl" simulationType="assignment">
        <MiriamAnnotation>
<rdf:RDF
   xmlns:dcterms="http://purl.org/dc/terms/"
   xmlns:rdf="http://www.w3.org/1999/02/22-rdf-syntax-ns#">
...
<rdf:RDF
  ...
  <rdf:Description rdf:about="#Reaction_8">
    <dcterms:created>
      ...
      <Reaction key="Reaction_0" name="make-cl-mRNA" reversible="false" fast="false">
        <ListOfProducts>
          <Product metabolite="Metabolite_1" stoichiometry="1"/>
        </ListOfProducts>
        <ListOfConstants>
          <Constant key="Parameter_4205" name="v" value="0.1"/>
        </ListOfConstants>
        <KineticLaw function="Function_6">
          <ListOfCallParameters>
            <CallParameter functionParameter="FunctionParameter_49">
    ...
    <ListOfModelParameterSets activeSet="ModelParameterSet_1">
      <ModelParameterSet key="ModelParameterSet_1" name="Initial State">
        ...
        <ModelParameterGroup cn="String=Initial Species Values" type="Group">
          ...
          <ModelParameter cn="CN=Root,Model=Repressilator MiSB,Vector=Compartments[compartment],Vector=Metabolites[TetR-mRNA]" value="1.204428358e+22" type="Species" simulationType="reactions"/>
        ...
        <ModelParameterGroup cn="String=Kinetic Parameters" type="Group">
          ...
          <ModelParameterGroup cn="CN=Root,Model=Repressilator MiSB,Vector=Reactions[make-cl-mRNA]" type="Reaction">
            <ModelParameter cn="CN=Root,Model=Repressilator MiSB,Vector=Reactions[make-cl-mRNA],ParameterGroup=Parameters,Parameter=v" value="0.1" type="ReactionParameter" simulationType="fixed"/>
          </ModelParameterGroup>
        </ModelParameterGroup>
      </ModelParameterSet>
    ...
    <InitialState type="initialState">
      0 0 0 1.204428358e+22 0 0 0 0.03 29.97 0.2164042561333445 216.1878518772112 0.06931471805599453 0.2 0.3465735902799726 2.885390081777927 6.931471805599453 1 0.0005 0.5 10 2 20 40 2 
    </InitialState>
  </Model>
  <ListOfTasks>
  ...
  <SBMLReference file="Represillator4.xml">
    ...
    <SBMLMap SBMLid="Adelta" COPASIkey="ModelValue_17"/>
    <SBMLMap SBMLid="Alfa_delta_tr" COPASIkey="ModelValue_15"/>
    <SBMLMap SBMLid="Alfa_min_tr" COPASIkey="ModelValue_16"/>
    ...
    <SBMLMap SBMLid="k_tl" COPASIkey="ModelValue_10"/>
    <SBMLMap SBMLid="kd_mRNA" COPASIkey="ModelValue_12"/>
    <SBMLMap SBMLid="kd_pr" COPASIkey="ModelValue_14"/>
    <SBMLMap SBMLid="mRNA_hl" COPASIkey="ModelValue_3"/>
    <SBMLMap SBMLid="mRNA_tv" COPASIkey="ModelValue_11"/>
    ...
    <SBMLMap SBMLid="make_cl_mRNA" COPASIkey="Reaction_0"/>
