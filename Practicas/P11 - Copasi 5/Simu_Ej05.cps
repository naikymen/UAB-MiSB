...
<!-- generated with COPASI 4.16 (Build 104) (http://www.copasi.org) at 2016-12-16 16:13:04 UTC -->
...
<rdf:RDF
  ...
  <Model key="Model_17" name="New Model" simulationType="time" timeUnit="min" volumeUnit="l" areaUnit="m²" lengthUnit="m" quantityUnit="mmol" type="deterministic" avogadroConstant="6.02214179e+23">
    <MiriamAnnotation>
<rdf:RDF
   xmlns:dcterms="http://purl.org/dc/terms/"
   xmlns:rdf="http://www.w3.org/1999/02/22-rdf-syntax-ns#">
  <rdf:Description rdf:about="#Model_17">
    ...
    <Comment>
      5) Per veure l’efecte de nivells més elevats de αIPM, com els que es trobarien si s’afegís
externament el metabòlit, afegeix una nova reacció de síntesi fictícia de αIPM amb un
valor constant de 0.18 mmol/min. Explica quin és l’efecte sobre els metabòlits i els
enzims. Descriu el model la resposta tal com s’espera?

Si, hay un aumento en la producción de enzimas, causado por la adición del inductor aIPM.
    </Comment>
    <ListOfCompartments>
      <Compartment key="Compartment_15" name="compartment" simulationType="fixed" dimensionality="3">
      </Compartment>
    </ListOfCompartments>
    <ListOfMetabolites>
      <Metabolite key="Metabolite_81" name="aIPM" simulationType="reactions" compartment="Compartment_15">
        <MiriamAnnotation>
<rdf:RDF xmlns:dcterms="http://purl.org/dc/terms/" xmlns:rdf="http://www.w3.org/1999/02/22-rdf-syntax-ns#">
  <rdf:Description rdf:about="#Metabolite_81">
    <dcterms:created>
      ...
      <Metabolite key="Metabolite_57" name="bIPM" simulationType="reactions" compartment="Compartment_15">
        <MiriamAnnotation>
<rdf:RDF xmlns:dcterms="http://purl.org/dc/terms/" xmlns:rdf="http://www.w3.org/1999/02/22-rdf-syntax-ns#">
  <rdf:Description rdf:about="#Metabolite_57">
    <dcterms:created>
      ...
      <Metabolite key="Metabolite_69" name="E2" simulationType="reactions" compartment="Compartment_15">
        <MiriamAnnotation>
<rdf:RDF xmlns:dcterms="http://purl.org/dc/terms/" xmlns:rdf="http://www.w3.org/1999/02/22-rdf-syntax-ns#">
  <rdf:Description rdf:about="#Metabolite_69">
    <dcterms:created>
      ...
      <Metabolite key="Metabolite_91" name="Leu" simulationType="reactions" compartment="Compartment_15">
        <MiriamAnnotation>
<rdf:RDF xmlns:dcterms="http://purl.org/dc/terms/" xmlns:rdf="http://www.w3.org/1999/02/22-rdf-syntax-ns#">
  <rdf:Description rdf:about="#Metabolite_91">
    <dcterms:created>
      ...
      <Metabolite key="Metabolite_93" name="E1" simulationType="reactions" compartment="Compartment_15">
        <MiriamAnnotation>
<rdf:RDF xmlns:dcterms="http://purl.org/dc/terms/" xmlns:rdf="http://www.w3.org/1999/02/22-rdf-syntax-ns#">
  <rdf:Description rdf:about="#Metabolite_93">
    <dcterms:created>
      ...
      <Metabolite key="Metabolite_95" name="E4" simulationType="fixed" compartment="Compartment_15">
        <MiriamAnnotation>
<rdf:RDF xmlns:dcterms="http://purl.org/dc/terms/" xmlns:rdf="http://www.w3.org/1999/02/22-rdf-syntax-ns#">
  ...
  <rdf:Description rdf:about="#Reaction_22">
    <dcterms:created>
      <rdf:Description>
        ...
        <ListOfConstants>
          <Constant key="Parameter_4166" name="kcat" value="0.32"/>
          <Constant key="Parameter_4167" name="Ki" value="0.66"/>
        </ListOfConstants>
    ...
    <dcterms:created>
      <rdf:Description>
        ...
        <ListOfConstants>
          ...
          <Constant key="Parameter_4241" name="Km" value="2.71"/>
        </ListOfConstants>
  ...
  <rdf:Description rdf:about="#Reaction_12">
    <dcterms:created>
      <rdf:Description>
        ...
        <ListOfConstants>
          <Constant key="Parameter_4242" name="kcat" value="108"/>
          <Constant key="Parameter_4410" name="Km" value="0.22"/>
        </ListOfConstants>
        <KineticLaw function="Function_43">
          <ListOfCallParameters>
            <CallParameter functionParameter="FunctionParameter_275">
  ...
  <rdf:Description rdf:about="#Reaction_13">
    <dcterms:created>
      <rdf:Description>
        ...
        <ListOfConstants>
          <Constant key="Parameter_4411" name="k1" value="0.011"/>
        </ListOfConstants>
  ...
  <rdf:Description rdf:about="#Reaction_15">
    <dcterms:created>
      <rdf:Description>
        ...
        <ListOfConstants>
          <Constant key="Parameter_4413" name="k1" value="0.077"/>
        </ListOfConstants>
        <KineticLaw function="Function_13">
          <ListOfCallParameters>
            <CallParameter functionParameter="FunctionParameter_81">
  ...
  <rdf:Description rdf:about="#Reaction_16">
    <dcterms:created>
      <rdf:Description>
        ...
        <ListOfConstants>
          <Constant key="Parameter_4414" name="Cmin" value="1.02e-06"/>
          <Constant key="Parameter_4415" name="Cmax" value="0.000508"/>
          <Constant key="Parameter_4315" name="KA" value="0.053"/>
        </ListOfConstants>
  ...
  <rdf:Description rdf:about="#Reaction_17">
    <dcterms:created>
      <rdf:Description>
        ...
        <ListOfConstants>
          <Constant key="Parameter_4316" name="Cmin" value="3.5e-07"/>
          <Constant key="Parameter_4317" name="Cmax" value="5.18e-05"/>
          <Constant key="Parameter_4318" name="KA" value="0.035"/>
        </ListOfConstants>
        <KineticLaw function="Function_44">
          <ListOfCallParameters>
            <CallParameter functionParameter="FunctionParameter_279">
  ...
  <rdf:Description rdf:about="#Reaction_18">
    <dcterms:created>
      <rdf:Description>
        ...
        <ListOfConstants>
          <Constant key="Parameter_4319" name="k1" value="0.0079"/>
        </ListOfConstants>
        <KineticLaw function="Function_13">
          <ListOfCallParameters>
            <CallParameter functionParameter="FunctionParameter_81">
  ...
  <rdf:Description rdf:about="#Reaction_19">
    <dcterms:created>
      <rdf:Description>
        ...
        <ListOfConstants>
          <Constant key="Parameter_4320" name="k1" value="0.0064"/>
        </ListOfConstants>
        <KineticLaw function="Function_13">
          <ListOfCallParameters>
            <CallParameter functionParameter="FunctionParameter_81">
  ...
  <rdf:Description rdf:about="#Reaction_20">
    <dcterms:created>
      <rdf:Description>
        ...
        <ListOfConstants>
          <Constant key="Parameter_4321" name="v" value="1.42"/>
        </ListOfConstants>
      ...
      <Reaction key="Reaction_21" name="in-aIPM" reversible="false" fast="false">
        <MiriamAnnotation>
<rdf:RDF xmlns:dcterms="http://purl.org/dc/terms/" xmlns:rdf="http://www.w3.org/1999/02/22-rdf-syntax-ns#">
  <rdf:Description rdf:about="#Reaction_21">
    <dcterms:created>
      <rdf:Description>
        <dcterms:W3CDTF>2016-12-16T16:48:34Z</dcterms:W3CDTF>
      </rdf:Description>
    </dcterms:created>
  </rdf:Description>
</rdf:RDF>
        ...
        <ListOfConstants>
          <Constant key="Parameter_4322" name="v" value="0.18"/>
        </ListOfConstants>
        <KineticLaw function="Function_6">
          <ListOfCallParameters>
            <CallParameter functionParameter="FunctionParameter_49">
...
<rdf:RDF xmlns:dcterms="http://purl.org/dc/terms/" xmlns:rdf="http://www.w3.org/1999/02/22-rdf-syntax-ns#">
    ...
    <ListOfModelParameterSets activeSet="ModelParameterSet_1">
      <ModelParameterSet key="ModelParameterSet_1" name="Initial State">
        ...
        <ModelParameterGroup cn="String=Kinetic Parameters" type="Group">
          ...
          <ModelParameterGroup cn="CN=Root,Model=New Model,Vector=Reactions[in-aIPM]" type="Reaction">
            <ModelParameter cn="CN=Root,Model=New Model,Vector=Reactions[in-aIPM],ParameterGroup=Parameters,Parameter=v" value="0.18" type="ReactionParameter" simulationType="fixed"/>
          </ModelParameterGroup>
        </ModelParameterGroup>
      </ModelParameterSet>
  ...
  <ListOfPlots>
    <PlotSpecification name="Concentraciones 5" type="Plot2D" active="1">
    ...
    <PlotSpecification name="Enzimas 5" type="Plot2D" active="1">
      <Parameter name="log X" type="bool" value="0"/>
      <Parameter name="log Y" type="bool" value="1"/>
      <ListOfPlotItems>
