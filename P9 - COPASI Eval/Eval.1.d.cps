...
<!-- generated with COPASI 4.16 (Build 104) (http://www.copasi.org) at 2016-11-25 15:06:40 UTC -->
...
<COPASI xmlns="http://www.copasi.org/static/schema" versionMajor="4" versionMinor="16" versionDevel="104" copasiSourcesModified="0">
  ...
  <Model key="Model_31" name="P9 Evaluable" simulationType="time" timeUnit="s" volumeUnit="l" areaUnit="m²" lengthUnit="m" quantityUnit="mmol" type="deterministic" avogadroConstant="6.02214179e+23">
    <MiriamAnnotation>
<rdf:RDF
  ...
  <rdf:Description rdf:about="#Model_31">
    ...
    <Comment>
      d) Quants modes elementals hi ha?. N’hi ha algun que sigui possible matemàticament tal com està definit el sistema, però improbable o impossible bioquímicament? (fitxer 2)

Hay 7 modos de flujo elemental.
El modo 2 es cíclico y no curriría
#	R1	R2	R6	R4	R5	R3	R7
2	0	1	0	-1	1	-1	0

Es cíclico porque se puede observar que la R1, R6 y R7 no están en este modo.
A -&gt; B -&gt; D -&gt; C -&gt; A .....
    </Comment>
    <ListOfCompartments>
      <Compartment key="Compartment_29" name="compartment" simulationType="fixed" dimensionality="3">
      </Compartment>
    </ListOfCompartments>
    <ListOfMetabolites>
      <Metabolite key="Metabolite_225" name="A" simulationType="reactions" compartment="Compartment_29">
        <MiriamAnnotation>
<rdf:RDF xmlns:dcterms="http://purl.org/dc/terms/" xmlns:rdf="http://www.w3.org/1999/02/22-rdf-syntax-ns#">
  <rdf:Description rdf:about="#Metabolite_225">
    <dcterms:created>
      ...
      <Metabolite key="Metabolite_221" name="Aex" simulationType="fixed" compartment="Compartment_29">
        <MiriamAnnotation>
<rdf:RDF xmlns:dcterms="http://purl.org/dc/terms/" xmlns:rdf="http://www.w3.org/1999/02/22-rdf-syntax-ns#">
  <rdf:Description rdf:about="#Metabolite_221">
    <dcterms:created>
      ...
      <Metabolite key="Metabolite_207" name="B" simulationType="reactions" compartment="Compartment_29">
        <MiriamAnnotation>
<rdf:RDF xmlns:dcterms="http://purl.org/dc/terms/" xmlns:rdf="http://www.w3.org/1999/02/22-rdf-syntax-ns#">
  <rdf:Description rdf:about="#Metabolite_207">
    <dcterms:created>
      ...
      <Metabolite key="Metabolite_235" name="Bext" simulationType="fixed" compartment="Compartment_29">
        <MiriamAnnotation>
<rdf:RDF xmlns:dcterms="http://purl.org/dc/terms/" xmlns:rdf="http://www.w3.org/1999/02/22-rdf-syntax-ns#">
  <rdf:Description rdf:about="#Metabolite_235">
    <dcterms:created>
      ...
      <Metabolite key="Metabolite_237" name="C" simulationType="reactions" compartment="Compartment_29">
        <MiriamAnnotation>
<rdf:RDF xmlns:dcterms="http://purl.org/dc/terms/" xmlns:rdf="http://www.w3.org/1999/02/22-rdf-syntax-ns#">
  <rdf:Description rdf:about="#Metabolite_237">
    <dcterms:created>
      ...
      <Metabolite key="Metabolite_239" name="D" simulationType="reactions" compartment="Compartment_29">
        <MiriamAnnotation>
<rdf:RDF xmlns:dcterms="http://purl.org/dc/terms/" xmlns:rdf="http://www.w3.org/1999/02/22-rdf-syntax-ns#">
  <rdf:Description rdf:about="#Metabolite_239">
    <dcterms:created>
      ...
      <Metabolite key="Metabolite_241" name="Dext" simulationType="fixed" compartment="Compartment_29">
        <MiriamAnnotation>
<rdf:RDF xmlns:dcterms="http://purl.org/dc/terms/" xmlns:rdf="http://www.w3.org/1999/02/22-rdf-syntax-ns#">
  ...
  <rdf:Description rdf:about="#Reaction_15">
    <dcterms:created>
      <rdf:Description>
        ...
        <ListOfConstants>
          <Constant key="Parameter_4418" name="Kms" value="0.1"/>
          <Constant key="Parameter_4419" name="Kmp" value="0.1"/>
          <Constant key="Parameter_3936" name="Vf" value="10"/>
          <Constant key="Parameter_3933" name="Keq" value="10"/>
        </ListOfConstants>
  ...
  <rdf:Description rdf:about="#Reaction_7">
    <dcterms:created>
      <rdf:Description>
        ...
        <ListOfConstants>
          <Constant key="Parameter_3935" name="Kms" value="0.1"/>
          <Constant key="Parameter_4413" name="Kmp" value="0.1"/>
          <Constant key="Parameter_4412" name="Vf" value="10"/>
          <Constant key="Parameter_3982" name="Keq" value="15"/>
        </ListOfConstants>
        <KineticLaw function="Function_36">
          <ListOfCallParameters>
            <CallParameter functionParameter="FunctionParameter_252">
  ...
  <rdf:Description rdf:about="#Reaction_6">
    <dcterms:created>
      <rdf:Description>
        ...
        <ListOfConstants>
          <Constant key="Parameter_4186" name="Kms" value="4"/>
          <Constant key="Parameter_4175" name="Kmp" value="0.1"/>
          <Constant key="Parameter_46" name="Vf" value="10"/>
          <Constant key="Parameter_4351" name="Keq" value="10"/>
        </ListOfConstants>
        <KineticLaw function="Function_36">
          <ListOfCallParameters>
            <CallParameter functionParameter="FunctionParameter_252">
  ...
  <rdf:Description rdf:about="#Reaction_5">
    <dcterms:created>
      <rdf:Description>
        ...
        <ListOfConstants>
          <Constant key="Parameter_4139" name="Kms" value="0.1"/>
          <Constant key="Parameter_4140" name="Kmp" value="0.1"/>
          <Constant key="Parameter_4141" name="Vf" value="10"/>
          <Constant key="Parameter_4143" name="Keq" value="6"/>
        </ListOfConstants>
        <KineticLaw function="Function_36">
          <ListOfCallParameters>
            <CallParameter functionParameter="FunctionParameter_252">
  ...
  <rdf:Description rdf:about="#Reaction_4">
    <dcterms:created>
      <rdf:Description>
        ...
        <ListOfConstants>
          <Constant key="Parameter_4353" name="Kms" value="0.1"/>
          <Constant key="Parameter_4145" name="Kmp" value="0.1"/>
          <Constant key="Parameter_4144" name="Vf" value="10"/>
          <Constant key="Parameter_4248" name="Keq" value="1.6"/>
        </ListOfConstants>
        <KineticLaw function="Function_36">
          <ListOfCallParameters>
            <CallParameter functionParameter="FunctionParameter_252">
  ...
  <rdf:Description rdf:about="#Reaction_3">
    <dcterms:created>
      <rdf:Description>
        ...
        <ListOfConstants>
          <Constant key="Parameter_4247" name="Kms" value="0.1"/>
          <Constant key="Parameter_3845" name="Kmp" value="0.1"/>
          <Constant key="Parameter_3844" name="Vf" value="10"/>
          <Constant key="Parameter_3843" name="Keq" value="4"/>
        </ListOfConstants>
        <KineticLaw function="Function_36">
          <ListOfCallParameters>
            <CallParameter functionParameter="FunctionParameter_252">
  ...
  <rdf:Description rdf:about="#Reaction_2">
    <dcterms:created>
      <rdf:Description>
        ...
        <ListOfConstants>
          <Constant key="Parameter_3842" name="Kms" value="0.1"/>
          <Constant key="Parameter_3841" name="Kmp" value="0.1"/>
          <Constant key="Parameter_3840" name="Vf" value="10"/>
          <Constant key="Parameter_3839" name="Keq" value="10"/>
        </ListOfConstants>
        <KineticLaw function="Function_36">
          <ListOfCallParameters>
            <CallParameter functionParameter="FunctionParameter_252">
