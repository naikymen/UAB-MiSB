...
<!-- generated with COPASI 4.16 (Build 104) (http://www.copasi.org) at 2016-11-11 16:28:33 UTC -->
...
Reaction scheme where the products are created from the reactants and the change of a product quantity is proportional to the product of reactant activities. The reaction scheme does not include any reverse process that creates the reactants from the products. The change of a product quantity is proportional to the quantity of one reactant.
  ...
  <Model key="Model_15" name="New Model" simulationType="time" timeUnit="s" volumeUnit="l" areaUnit="m²" lengthUnit="m" quantityUnit="mmol" type="deterministic" avogadroConstant="6.02214179e+23">
    <MiriamAnnotation>
<rdf:RDF
...
c) Todos los dG, MAR y concentraciones finales cambian (dirigiéndo más flujo hacia la rama P2) pero no en la misma magnitud que el cambio en la Keq.
En otras palabras, cambiar la Keq en ese nodo no tuvo un efecto fuerte sobre el comportamiento del sistema.

d) Al igual que el caso anterior, el flujo de entrada se distribuye entre las dos ramas, pero no de forma simétrica. El flujo a través de la rama P2 aumenta un poco.
...
e) Al cambiar todas las Keq, todo el sistema se desplaza hacia los productos y las concentraciones en el EE disminuyen.
Los flujos se mantienen y los delta G se hacen más negativos.

    </Comment>
    <ListOfCompartments>
      <Compartment key="Compartment_14" name="compartment" simulationType="fixed" dimensionality="3">
      </Compartment>
    </ListOfCompartments>
    <ListOfMetabolites>
      <Metabolite key="Metabolite_118" name="S" simulationType="reactions" compartment="Compartment_14">
        <MiriamAnnotation>
<rdf:RDF xmlns:dcterms="http://purl.org/dc/terms/" xmlns:rdf="http://www.w3.org/1999/02/22-rdf-syntax-ns#">
  <rdf:Description rdf:about="#Metabolite_118">
    <dcterms:created>
      ...
      <Metabolite key="Metabolite_114" name="X1" simulationType="reactions" compartment="Compartment_14">
        <MiriamAnnotation>
<rdf:RDF xmlns:dcterms="http://purl.org/dc/terms/" xmlns:rdf="http://www.w3.org/1999/02/22-rdf-syntax-ns#">
  <rdf:Description rdf:about="#Metabolite_114">
    <dcterms:created>
      ...
      <Metabolite key="Metabolite_78" name="X2" simulationType="reactions" compartment="Compartment_14">
        <MiriamAnnotation>
<rdf:RDF xmlns:dcterms="http://purl.org/dc/terms/" xmlns:rdf="http://www.w3.org/1999/02/22-rdf-syntax-ns#">
  <rdf:Description rdf:about="#Metabolite_78">
    <dcterms:created>
      ...
      <Metabolite key="Metabolite_96" name="X3" simulationType="reactions" compartment="Compartment_14">
        <MiriamAnnotation>
<rdf:RDF xmlns:dcterms="http://purl.org/dc/terms/" xmlns:rdf="http://www.w3.org/1999/02/22-rdf-syntax-ns#">
  <rdf:Description rdf:about="#Metabolite_96">
    <dcterms:created>
      ...
      <Metabolite key="Metabolite_130" name="X4" simulationType="reactions" compartment="Compartment_14">
        <MiriamAnnotation>
<rdf:RDF xmlns:dcterms="http://purl.org/dc/terms/" xmlns:rdf="http://www.w3.org/1999/02/22-rdf-syntax-ns#">
  <rdf:Description rdf:about="#Metabolite_130">
    <dcterms:created>
      ...
      <Metabolite key="Metabolite_132" name="X5" simulationType="reactions" compartment="Compartment_14">
        <MiriamAnnotation>
<rdf:RDF xmlns:dcterms="http://purl.org/dc/terms/" xmlns:rdf="http://www.w3.org/1999/02/22-rdf-syntax-ns#">
  <rdf:Description rdf:about="#Metabolite_132">
    <dcterms:created>
      ...
      <Metabolite key="Metabolite_134" name="X6" simulationType="reactions" compartment="Compartment_14">
        <MiriamAnnotation>
<rdf:RDF xmlns:dcterms="http://purl.org/dc/terms/" xmlns:rdf="http://www.w3.org/1999/02/22-rdf-syntax-ns#">
  <rdf:Description rdf:about="#Metabolite_134">
    <dcterms:created>
      ...
      <Metabolite key="Metabolite_136" name="P1" simulationType="reactions" compartment="Compartment_14">
        <MiriamAnnotation>
<rdf:RDF xmlns:dcterms="http://purl.org/dc/terms/" xmlns:rdf="http://www.w3.org/1999/02/22-rdf-syntax-ns#">
  <rdf:Description rdf:about="#Metabolite_136">
    <dcterms:created>
      ...
      <Metabolite key="Metabolite_138" name="P2" simulationType="reactions" compartment="Compartment_14">
        <MiriamAnnotation>
<rdf:RDF xmlns:dcterms="http://purl.org/dc/terms/" xmlns:rdf="http://www.w3.org/1999/02/22-rdf-syntax-ns#">
  ...
  <rdf:Description rdf:about="#Reaction_6">
    <dcterms:created>
      <rdf:Description>
        ...
        <ListOfConstants>
          <Constant key="Parameter_3737" name="Kms" value="50"/>
          <Constant key="Parameter_3738" name="Kmp" value="50"/>
          <Constant key="Parameter_3960" name="Vf" value="100"/>
          <Constant key="Parameter_3961" name="Keq" value="64"/>
        </ListOfConstants>
  ...
  <rdf:Description rdf:about="#Reaction_5">
    <dcterms:created>
      <rdf:Description>
        ...
        <ListOfConstants>
          <Constant key="Parameter_3814" name="Kms" value="50"/>
          <Constant key="Parameter_3813" name="Kmp" value="50"/>
          <Constant key="Parameter_3812" name="Vf" value="100"/>
          <Constant key="Parameter_3811" name="Keq" value="64"/>
        </ListOfConstants>
        <KineticLaw function="Function_36">
          <ListOfCallParameters>
            <CallParameter functionParameter="FunctionParameter_252">
  ...
  <rdf:Description rdf:about="#Reaction_4">
    <dcterms:created>
      <rdf:Description>
        ...
        <ListOfConstants>
          <Constant key="Parameter_3810" name="Kms" value="50"/>
          <Constant key="Parameter_3809" name="Kmp" value="50"/>
          <Constant key="Parameter_3808" name="Vf" value="100"/>
          <Constant key="Parameter_3807" name="Keq" value="64"/>
        </ListOfConstants>
        <KineticLaw function="Function_36">
          <ListOfCallParameters>
            <CallParameter functionParameter="FunctionParameter_252">
  ...
  <rdf:Description rdf:about="#Reaction_3">
    <dcterms:created>
      <rdf:Description>
        ...
        <ListOfConstants>
          <Constant key="Parameter_3806" name="Kms" value="50"/>
          <Constant key="Parameter_3805" name="Kmp" value="50"/>
          <Constant key="Parameter_3804" name="Vf" value="100"/>
          <Constant key="Parameter_3803" name="Keq" value="64"/>
        </ListOfConstants>
        <KineticLaw function="Function_36">
          <ListOfCallParameters>
            <CallParameter functionParameter="FunctionParameter_252">
  ...
  <rdf:Description rdf:about="#Reaction_2">
    <dcterms:created>
      <rdf:Description>
        ...
        <ListOfConstants>
          <Constant key="Parameter_3802" name="Kms" value="50"/>
          <Constant key="Parameter_3801" name="Kmp" value="50"/>
          <Constant key="Parameter_3800" name="Vf" value="100"/>
          <Constant key="Parameter_3799" name="Keq" value="64"/>
        </ListOfConstants>
        <KineticLaw function="Function_36">
          <ListOfCallParameters>
            <CallParameter functionParameter="FunctionParameter_252">
  ...
  <rdf:Description rdf:about="#Reaction_1">
    <dcterms:created>
      <rdf:Description>
        ...
        <ListOfConstants>
          <Constant key="Parameter_3798" name="Kms" value="50"/>
          <Constant key="Parameter_3797" name="Kmp" value="50"/>
          <Constant key="Parameter_3796" name="Vf" value="100"/>
          <Constant key="Parameter_3795" name="Keq" value="64"/>
        </ListOfConstants>
        <KineticLaw function="Function_36">
          <ListOfCallParameters>
            <CallParameter functionParameter="FunctionParameter_252">
  ...
  <rdf:Description rdf:about="#Reaction_9">
    <dcterms:created>
      <rdf:Description>
        ...
        <ListOfConstants>
          <Constant key="Parameter_3794" name="Kms" value="50"/>
          <Constant key="Parameter_3793" name="Kmp" value="50"/>
          <Constant key="Parameter_3792" name="Vf" value="100"/>
          <Constant key="Parameter_3791" name="Keq" value="64"/>
        </ListOfConstants>
        <KineticLaw function="Function_36">
          <ListOfCallParameters>
            <CallParameter functionParameter="FunctionParameter_252">
  ...
  <rdf:Description rdf:about="#Reaction_10">
    <dcterms:created>
      <rdf:Description>
        ...
        <ListOfConstants>
          <Constant key="Parameter_3790" name="Kms" value="50"/>
          <Constant key="Parameter_3789" name="Kmp" value="50"/>
          <Constant key="Parameter_3788" name="Vf" value="100"/>
          <Constant key="Parameter_3787" name="Keq" value="64"/>
        </ListOfConstants>
        <KineticLaw function="Function_36">
          <ListOfCallParameters>
            <CallParameter functionParameter="FunctionParameter_252">
  ...
  <rdf:Description rdf:about="#Reaction_19">
    <dcterms:created>
      <rdf:Description>
        ...
        <ListOfConstants>
          <Constant key="Parameter_3786" name="v" value="50"/>
        </ListOfConstants>
  ...
  <rdf:Description rdf:about="#Reaction_20">
    <dcterms:created>
      <rdf:Description>
        ...
        <ListOfConstants>
          <Constant key="Parameter_3785" name="k1" value="1"/>
        </ListOfConstants>
  ...
  <rdf:Description rdf:about="#Reaction_21">
    <dcterms:created>
      <rdf:Description>
        ...
        <ListOfConstants>
          <Constant key="Parameter_3784" name="k1" value="1"/>
        </ListOfConstants>
        <KineticLaw function="Function_13">
          <ListOfCallParameters>
            <CallParameter functionParameter="FunctionParameter_81">
    ...
    <ListOfModelParameterSets activeSet="ModelParameterSet_1">
      <ModelParameterSet key="ModelParameterSet_1" name="Initial State">
        ...
        <ModelParameterGroup cn="String=Initial Global Quantities" type="Group">
          ...
          <ModelParameter cn="CN=Root,Model=New Model,Vector=Values[Des1]" value="0.0015625" type="ModelValue" simulationType="assignment"/>
          <ModelParameter cn="CN=Root,Model=New Model,Vector=Values[Des2]" value="0.015625" type="ModelValue" simulationType="assignment"/>
          <ModelParameter cn="CN=Root,Model=New Model,Vector=Values[Des3]" value="0.015625" type="ModelValue" simulationType="assignment"/>
          <ModelParameter cn="CN=Root,Model=New Model,Vector=Values[Des4]" value="0.015625" type="ModelValue" simulationType="assignment"/>
          <ModelParameter cn="CN=Root,Model=New Model,Vector=Values[Des5]" value="0.015625" type="ModelValue" simulationType="assignment"/>
          <ModelParameter cn="CN=Root,Model=New Model,Vector=Values[Des6]" value="0.015625" type="ModelValue" simulationType="assignment"/>
          <ModelParameter cn="CN=Root,Model=New Model,Vector=Values[Des7]" value="0.015625" type="ModelValue" simulationType="assignment"/>
          <ModelParameter cn="CN=Root,Model=New Model,Vector=Values[Des8]" value="0.015625" type="ModelValue" simulationType="assignment"/>
        </ModelParameterGroup>
        <ModelParameterGroup cn="String=Kinetic Parameters" type="Group">
          ...
          <ModelParameterGroup cn="CN=Root,Model=New Model,Vector=Reactions[R7]" type="Reaction">
            ...
            <ModelParameter cn="CN=Root,Model=New Model,Vector=Reactions[R7],ParameterGroup=Parameters,Parameter=Vf" value="100" type="ReactionParameter" simulationType="assignment">
              <InitialExpression>
                &lt;CN=Root,Model=New Model,Vector=Values[Vf],Reference=InitialValue&gt;
              </InitialExpression>
            </ModelParameter>
    ...
    <InitialState type="initialState">
      0 6.022141790000001e+20 6.02214179e+21 6.022141790000001e+20 6.022141790000001e+20 6.022141790000001e+20 6.022141790000001e+20 6.022141790000001e+20 6.022141790000001e+20 6.022141790000001e+20 0.1 1 1 1 1 1 1 1 -15.95503198620683 -10.26935532465053 -10.26935532465053 -10.26935532465053 -10.26935532465053 -10.26935532465053 -10.26935532465053 -10.26935532465053 0.0015625 0.015625 0.015625 0.015625 0.015625 0.015625 0.015625 0.015625 1 64 50 100 
    </InitialState>
  </Model>
  <ListOfTasks>
