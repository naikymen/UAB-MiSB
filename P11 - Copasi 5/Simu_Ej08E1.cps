...
<!-- generated with COPASI 4.16 (Build 104) (http://www.copasi.org) at 2016-12-16 16:36:25 UTC -->
...
<rdf:RDF
  ...
  <Model key="Model_24" name="New Model" simulationType="time" timeUnit="min" volumeUnit="l" areaUnit="m²" lengthUnit="m" quantityUnit="mmol" type="deterministic" avogadroConstant="6.02214179e+23">
    <MiriamAnnotation>
<rdf:RDF
   xmlns:dcterms="http://purl.org/dc/terms/"
   xmlns:rdf="http://www.w3.org/1999/02/22-rdf-syntax-ns#">
  <rdf:Description rdf:about="#Model_24">
    ...
    <Comment>
      8) Un altra estratègia per millorar la dinàmica consistiria en modificar les velocitats de
transcripció dels promotors per a E leu1 i E leu2 . Per veure quin efecte tindria en cada cas
amb el model, s’hauria de modificar els valors dels paràmetres c max al model de
referència. Fes-ho per a la síntesi de E leu1 (reacció SEleu1) aprofitant la utilitat
‘Parameter scan’. A la pantalla del menú corresponent polsa el botó ‘create’ i al menú
emergent selecciona Reactions-&amp;amp;gt;Reaction parameters-&amp;amp;gt;SEleu1-&amp;amp;gt;cmax i polsa ‘OK’.
Selecciona els valors mínim (0.0001), màxim (0.001) i 10 intervals. Assegurat que està
seleccionada la tasca ‘time course’ i pressiona ‘run’. Quin és l’efecte d’augmentar c max
sobre els enzims i els metabòlits?. Repeteix el procediment per al paràmetre c max de
SEleu2 amb valors els valors mínim (0.00001), màxim (0.0001). Compara amb l’article
(pg 1351 i fig. 9) i explica els resultats.

Mejorar el promotor de E1, aumenta bIPM y baja aIPM (pero no tanto). El efecto se manifiesta una vez que se remueve la entrada de Leu, pero no antes (como en la sobreexpresión).
    </Comment>
    <ListOfCompartments>
      <Compartment key="Compartment_22" name="compartment" simulationType="fixed" dimensionality="3">
      </Compartment>
    </ListOfCompartments>
    <ListOfMetabolites>
      <Metabolite key="Metabolite_123" name="aIPM" simulationType="reactions" compartment="Compartment_22">
        <MiriamAnnotation>
<rdf:RDF xmlns:dcterms="http://purl.org/dc/terms/" xmlns:rdf="http://www.w3.org/1999/02/22-rdf-syntax-ns#">
  <rdf:Description rdf:about="#Metabolite_123">
    <dcterms:created>
      ...
      <Metabolite key="Metabolite_99" name="bIPM" simulationType="reactions" compartment="Compartment_22">
        <MiriamAnnotation>
<rdf:RDF xmlns:dcterms="http://purl.org/dc/terms/" xmlns:rdf="http://www.w3.org/1999/02/22-rdf-syntax-ns#">
  <rdf:Description rdf:about="#Metabolite_99">
    <dcterms:created>
      ...
      <Metabolite key="Metabolite_111" name="E2" simulationType="reactions" compartment="Compartment_22">
        <MiriamAnnotation>
<rdf:RDF xmlns:dcterms="http://purl.org/dc/terms/" xmlns:rdf="http://www.w3.org/1999/02/22-rdf-syntax-ns#">
  <rdf:Description rdf:about="#Metabolite_111">
    <dcterms:created>
      ...
      <Metabolite key="Metabolite_133" name="Leu" simulationType="reactions" compartment="Compartment_22">
        <MiriamAnnotation>
<rdf:RDF xmlns:dcterms="http://purl.org/dc/terms/" xmlns:rdf="http://www.w3.org/1999/02/22-rdf-syntax-ns#">
  <rdf:Description rdf:about="#Metabolite_133">
    <dcterms:created>
      ...
      <Metabolite key="Metabolite_135" name="E1" simulationType="reactions" compartment="Compartment_22">
        <MiriamAnnotation>
<rdf:RDF xmlns:dcterms="http://purl.org/dc/terms/" xmlns:rdf="http://www.w3.org/1999/02/22-rdf-syntax-ns#">
  <rdf:Description rdf:about="#Metabolite_135">
    <dcterms:created>
      ...
      <Metabolite key="Metabolite_137" name="E4" simulationType="fixed" compartment="Compartment_22">
        <MiriamAnnotation>
<rdf:RDF xmlns:dcterms="http://purl.org/dc/terms/" xmlns:rdf="http://www.w3.org/1999/02/22-rdf-syntax-ns#">
  <rdf:Description rdf:about="#Metabolite_137">
    ...
    <ListOfModelValues>
      <ModelValue key="ModelValue_0" name="Fext" simulationType="fixed">
        <MiriamAnnotation>
<rdf:RDF xmlns:dcterms="http://purl.org/dc/terms/" xmlns:rdf="http://www.w3.org/1999/02/22-rdf-syntax-ns#">
  <rdf:Description rdf:about="#ModelValue_0">
    ...
    <ListOfReactions>
      <Reaction key="Reaction_10" name="sin-aIPM" reversible="false" fast="false">
        <MiriamAnnotation>
<rdf:RDF xmlns:dcterms="http://purl.org/dc/terms/" xmlns:rdf="http://www.w3.org/1999/02/22-rdf-syntax-ns#">
  <rdf:Description rdf:about="#Reaction_10">
    <dcterms:created>
      <rdf:Description>
        ...
        <ListOfConstants>
          <Constant key="Parameter_4242" name="kcat" value="0.32"/>
          <Constant key="Parameter_4241" name="Ki" value="0.66"/>
        </ListOfConstants>
      ...
      <Reaction key="Reaction_11" name="sin-bIPM" reversible="false" fast="false">
        <MiriamAnnotation>
<rdf:RDF xmlns:dcterms="http://purl.org/dc/terms/" xmlns:rdf="http://www.w3.org/1999/02/22-rdf-syntax-ns#">
  <rdf:Description rdf:about="#Reaction_11">
    <dcterms:created>
      <rdf:Description>
        ...
        <ListOfConstants>
          <Constant key="Parameter_4244" name="kcat" value="2640"/>
          <Constant key="Parameter_4167" name="Km" value="2.71"/>
        </ListOfConstants>
      ...
      <Reaction key="Reaction_0" name="sin-Leu" reversible="false" fast="false">
        <MiriamAnnotation>
<rdf:RDF xmlns:dcterms="http://purl.org/dc/terms/" xmlns:rdf="http://www.w3.org/1999/02/22-rdf-syntax-ns#">
  <rdf:Description rdf:about="#Reaction_0">
    <dcterms:created>
      <rdf:Description>
        ...
        <ListOfConstants>
          <Constant key="Parameter_4166" name="kcat" value="108"/>
          <Constant key="Parameter_4404" name="Km" value="0.22"/>
        </ListOfConstants>
        <KineticLaw function="Function_43">
          <ListOfCallParameters>
            <CallParameter functionParameter="FunctionParameter_275">
      ...
      <Reaction key="Reaction_1" name="deg-aIPM" reversible="false" fast="false">
        <MiriamAnnotation>
<rdf:RDF xmlns:dcterms="http://purl.org/dc/terms/" xmlns:rdf="http://www.w3.org/1999/02/22-rdf-syntax-ns#">
  <rdf:Description rdf:about="#Reaction_1">
    <dcterms:created>
      <rdf:Description>
        ...
        <ListOfConstants>
          <Constant key="Parameter_4449" name="k1" value="0.011"/>
        </ListOfConstants>
      ...
      <Reaction key="Reaction_2" name="deg-bIPM" reversible="false" fast="false">
        <MiriamAnnotation>
<rdf:RDF xmlns:dcterms="http://purl.org/dc/terms/" xmlns:rdf="http://www.w3.org/1999/02/22-rdf-syntax-ns#">
  <rdf:Description rdf:about="#Reaction_2">
    <dcterms:created>
      <rdf:Description>
        ...
        <ListOfConstants>
          <Constant key="Parameter_4450" name="k1" value="0.008"/>
        </ListOfConstants>
        <KineticLaw function="Function_13">
          <ListOfCallParameters>
            <CallParameter functionParameter="FunctionParameter_81">
      ...
      <Reaction key="Reaction_3" name="deg-Leu" reversible="false" fast="false">
        <MiriamAnnotation>
<rdf:RDF xmlns:dcterms="http://purl.org/dc/terms/" xmlns:rdf="http://www.w3.org/1999/02/22-rdf-syntax-ns#">
  <rdf:Description rdf:about="#Reaction_3">
    <dcterms:created>
      <rdf:Description>
        ...
        <ListOfConstants>
          <Constant key="Parameter_4456" name="k1" value="0.077"/>
        </ListOfConstants>
        <KineticLaw function="Function_13">
          <ListOfCallParameters>
            <CallParameter functionParameter="FunctionParameter_81">
      ...
      <Reaction key="Reaction_4" name="sin-E1" reversible="false" fast="false">
        <MiriamAnnotation>
<rdf:RDF xmlns:dcterms="http://purl.org/dc/terms/" xmlns:rdf="http://www.w3.org/1999/02/22-rdf-syntax-ns#">
  <rdf:Description rdf:about="#Reaction_4">
    <dcterms:created>
      <rdf:Description>
        ...
        <ListOfConstants>
          <Constant key="Parameter_4454" name="Cmin" value="1.02e-06"/>
          <Constant key="Parameter_4452" name="Cmax" value="0.000508"/>
          <Constant key="Parameter_4453" name="KA" value="0.053"/>
        </ListOfConstants>
      ...
      <Reaction key="Reaction_5" name="sin-E2" reversible="false" fast="false">
        <MiriamAnnotation>
<rdf:RDF xmlns:dcterms="http://purl.org/dc/terms/" xmlns:rdf="http://www.w3.org/1999/02/22-rdf-syntax-ns#">
  <rdf:Description rdf:about="#Reaction_5">
    <dcterms:created>
      <rdf:Description>
        ...
        <ListOfConstants>
          <Constant key="Parameter_4451" name="Cmin" value="3.5e-07"/>
          <Constant key="Parameter_4455" name="Cmax" value="5.18e-05"/>
          <Constant key="Parameter_4460" name="KA" value="0.035"/>
        </ListOfConstants>
        <KineticLaw function="Function_44">
          <ListOfCallParameters>
            <CallParameter functionParameter="FunctionParameter_279">
      ...
      <Reaction key="Reaction_6" name="deg-E1" reversible="false" fast="false">
        <MiriamAnnotation>
<rdf:RDF xmlns:dcterms="http://purl.org/dc/terms/" xmlns:rdf="http://www.w3.org/1999/02/22-rdf-syntax-ns#">
  <rdf:Description rdf:about="#Reaction_6">
    <dcterms:created>
      <rdf:Description>
        ...
        <ListOfConstants>
          <Constant key="Parameter_4462" name="k1" value="0.0079"/>
        </ListOfConstants>
        <KineticLaw function="Function_13">
          <ListOfCallParameters>
            <CallParameter functionParameter="FunctionParameter_81">
      ...
      <Reaction key="Reaction_7" name="deg-E2" reversible="false" fast="false">
        <MiriamAnnotation>
<rdf:RDF xmlns:dcterms="http://purl.org/dc/terms/" xmlns:rdf="http://www.w3.org/1999/02/22-rdf-syntax-ns#">
  <rdf:Description rdf:about="#Reaction_7">
    <dcterms:created>
      <rdf:Description>
        ...
        <ListOfConstants>
          <Constant key="Parameter_4458" name="k1" value="0.0064"/>
        </ListOfConstants>
        <KineticLaw function="Function_13">
          <ListOfCallParameters>
            <CallParameter functionParameter="FunctionParameter_81">
      ...
      <Reaction key="Reaction_8" name="in-Leu" reversible="false" fast="false">
        <MiriamAnnotation>
<rdf:RDF xmlns:dcterms="http://purl.org/dc/terms/" xmlns:rdf="http://www.w3.org/1999/02/22-rdf-syntax-ns#">
  <rdf:Description rdf:about="#Reaction_8">
    <dcterms:created>
      <rdf:Description>
        ...
        <ListOfConstants>
          <Constant key="Parameter_4459" name="v" value="1.42"/>
        </ListOfConstants>
    ...
    <ListOfEvents>
      <Event key="Event_0" name="Fiesta" fireAtInitialTime="0" persistentTrigger="0">
        <MiriamAnnotation>
<rdf:RDF xmlns:dcterms="http://purl.org/dc/terms/" xmlns:rdf="http://www.w3.org/1999/02/22-rdf-syntax-ns#">
  <rdf:Description rdf:about="#Event_0">
    ...
    <InitialState type="initialState">
      0 1.083985522200001e+18 1.10807408936e+22 5.179041939400001e+18 4.7574920141e+16 1.3248711938e+17 6.022141790000001e+20 1 1.42 
    </InitialState>
  </Model>
  <ListOfTasks>
      ...
      <Problem>
        ...
        <ParameterGroup name="ScanItems">
          <ParameterGroup name="ScanItem">
            ...
            <Parameter name="Object" type="cn" value="CN=Root,Model=New Model,Vector=Reactions[sin-E1],ParameterGroup=Parameters,Parameter=Cmax,Reference=Value"/>
  ...
  <ListOfPlots>
    <PlotSpecification name="Concentraciones 8E1" type="Plot2D" active="1">
    ...
    <PlotSpecification name="Enzimas 8E1" type="Plot2D" active="1">
      <Parameter name="log X" type="bool" value="0"/>
      <Parameter name="log Y" type="bool" value="1"/>
      <ListOfPlotItems>
