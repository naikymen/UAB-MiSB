...
<!-- generated with COPASI 4.16 (Build 104) (http://www.copasi.org) at 2017-01-10 15:00:05 UTC -->
  ...
  <rdf:Description rdf:about="#Reaction_9">
    <dcterms:created>
      <rdf:Description>
        ...
        <ListOfConstants>
          <Constant key="Parameter_4165" name="V" value="0.76"/>
          <Constant key="Parameter_4166" name="h" value="4"/>
          <Constant key="Parameter_4167" name="Shalve" value="1"/>
        </ListOfConstants>
  ...
  <rdf:Description rdf:about="#Reaction_8">
    <dcterms:created>
      <rdf:Description>
        ...
        <ListOfConstants>
          <Constant key="Parameter_4168" name="Km" value="0.5"/>
          <Constant key="Parameter_4169" name="V" value="0.65"/>
        </ListOfConstants>
  ...
  <rdf:Description rdf:about="#Reaction_7">
    <dcterms:created>
      <rdf:Description>
        ...
        <ListOfConstants>
          <Constant key="Parameter_4170" name="ks" value="0.38"/>
        </ListOfConstants>
  ...
  <rdf:Description rdf:about="#Reaction_6">
    <dcterms:created>
      <rdf:Description>
        ...
        <ListOfConstants>
          <Constant key="Parameter_4171" name="Km" value="2"/>
          <Constant key="Parameter_4172" name="V" value="3.2"/>
        </ListOfConstants>
        <KineticLaw function="Function_8">
          <ListOfCallParameters>
            <CallParameter functionParameter="FunctionParameter_41">
  ...
  <rdf:Description rdf:about="#Reaction_5">
    <dcterms:created>
      <rdf:Description>
        ...
        <ListOfConstants>
          <Constant key="Parameter_4173" name="Km" value="2"/>
          <Constant key="Parameter_4174" name="V" value="1.58"/>
        </ListOfConstants>
        <KineticLaw function="Function_8">
          <ListOfCallParameters>
            <CallParameter functionParameter="FunctionParameter_41">
  ...
  <rdf:Description rdf:about="#Reaction_4">
    <dcterms:created>
      <rdf:Description>
        ...
        <ListOfConstants>
          <Constant key="Parameter_4175" name="Km" value="2"/>
          <Constant key="Parameter_4176" name="V" value="5"/>
        </ListOfConstants>
        <KineticLaw function="Function_8">
          <ListOfCallParameters>
            <CallParameter functionParameter="FunctionParameter_41">
  ...
  <rdf:Description rdf:about="#Reaction_3">
    <dcterms:created>
      <rdf:Description>
        ...
        <ListOfConstants>
          <Constant key="Parameter_4177" name="Km" value="2"/>
          <Constant key="Parameter_4178" name="V" value="2.5"/>
        </ListOfConstants>
        <KineticLaw function="Function_8">
          <ListOfCallParameters>
            <CallParameter functionParameter="FunctionParameter_41">
  ...
  <rdf:Description rdf:about="#Reaction_2">
    <dcterms:created>
      <rdf:Description>
        ...
        <ListOfConstants>
          <Constant key="Parameter_4179" name="k1" value="1.9"/>
        </ListOfConstants>
  ...
  <rdf:Description rdf:about="#Reaction_1">
    <dcterms:created>
      <rdf:Description>
        ...
        <ListOfConstants>
          <Constant key="Parameter_4180" name="Km" value="0.2"/>
          <Constant key="Parameter_4181" name="V" value="0.95"/>
        </ListOfConstants>
        <KineticLaw function="Function_8">
          <ListOfCallParameters>
            <CallParameter functionParameter="FunctionParameter_41">
  ...
  <rdf:Description rdf:about="#Reaction_0">
    <dcterms:created>
      <rdf:Description>
        ...
        <ListOfConstants>
          <Constant key="Parameter_4182" name="k1" value="1.3"/>
        </ListOfConstants>
        <KineticLaw function="Function_13">
          <ListOfCallParameters>
            <CallParameter functionParameter="FunctionParameter_81">
...
<rdf:RDF xmlns:dcterms="http://purl.org/dc/terms/" xmlns:rdf="http://www.w3.org/1999/02/22-rdf-syntax-ns#">
  <rdf:Description rdf:about="#Event_0">
    ...
    <ListOfModelParameterSets activeSet="ModelParameterSet_0">
      <ModelParameterSet key="ModelParameterSet_0" name="Initial State">
        ...
        <ModelParameterGroup cn="String=Initial Global Quantities" type="Group">
          ...
          <ModelParameter cn="CN=Root,Model=New Model,Vector=Values[periodMaxTime]" value="NaN" type="ModelValue" simulationType="fixed"/>
    ...
    <InitialState type="initialState">
      0 1.5055354475e+17 1.5055354475e+17 6.02214179e+16 1.5055354475e+17 1.5055354475e+17 1 NaN 1 0.76 1 0.65 0.5 0.38 2 3.2 2 1.58 2 5 2 2.5 1.9 1.3 0.95 0.2 4 NaN 0 0 0 0 
    </InitialState>
  </Model>
  <ListOfTasks>
    ...
    <Task key="Task_1" name="Time-Course" type="timeCourse" scheduled="false" updateModel="false">
      <Problem>
        ...
        <Parameter name="StepSize" type="float" value="0.0072"/>
