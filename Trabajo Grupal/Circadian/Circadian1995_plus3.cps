...
<!-- generated with COPASI 4.16 (Build 104) (http://www.copasi.org) at 2017-01-09 11:32:19 UTC -->
  ...
  <rdf:Description rdf:about="#Reaction_10">
    <dcterms:created>
      <rdf:Description>
        ...
        <ListOfConstants>
          <Constant key="Parameter_3795" name="V" value="0.76"/>
          <Constant key="Parameter_3794" name="h" value="4"/>
          <Constant key="Parameter_3793" name="Shalve" value="1"/>
        </ListOfConstants>
  ...
  <rdf:Description rdf:about="#Reaction_11">
    <dcterms:created>
      <rdf:Description>
        ...
        <ListOfConstants>
          <Constant key="Parameter_3792" name="Km" value="0.5"/>
          <Constant key="Parameter_3791" name="V" value="0.65"/>
        </ListOfConstants>
  ...
  <rdf:Description rdf:about="#Reaction_12">
    <dcterms:created>
      <rdf:Description>
        ...
        <ListOfConstants>
          <Constant key="Parameter_3790" name="ks" value="0.38"/>
        </ListOfConstants>
  ...
  <rdf:Description rdf:about="#Reaction_13">
    <dcterms:created>
      <rdf:Description>
        ...
        <ListOfConstants>
          <Constant key="Parameter_3789" name="Km" value="2"/>
          <Constant key="Parameter_3788" name="V" value="3.2"/>
        </ListOfConstants>
        <KineticLaw function="Function_8">
          <ListOfCallParameters>
            <CallParameter functionParameter="FunctionParameter_41">
  ...
  <rdf:Description rdf:about="#Reaction_14">
    <dcterms:created>
      <rdf:Description>
        ...
        <ListOfConstants>
          <Constant key="Parameter_3787" name="Km" value="2"/>
          <Constant key="Parameter_3786" name="V" value="1.58"/>
        </ListOfConstants>
        <KineticLaw function="Function_8">
          <ListOfCallParameters>
            <CallParameter functionParameter="FunctionParameter_41">
  ...
  <rdf:Description rdf:about="#Reaction_15">
    <dcterms:created>
      <rdf:Description>
        ...
        <ListOfConstants>
          <Constant key="Parameter_3785" name="Km" value="2"/>
          <Constant key="Parameter_3784" name="V" value="5"/>
        </ListOfConstants>
        <KineticLaw function="Function_8">
          <ListOfCallParameters>
            <CallParameter functionParameter="FunctionParameter_41">
  ...
  <rdf:Description rdf:about="#Reaction_16">
    <dcterms:created>
      <rdf:Description>
        ...
        <ListOfConstants>
          <Constant key="Parameter_3783" name="Km" value="2"/>
          <Constant key="Parameter_3782" name="V" value="2.5"/>
        </ListOfConstants>
        <KineticLaw function="Function_8">
          <ListOfCallParameters>
            <CallParameter functionParameter="FunctionParameter_41">
  ...
  <rdf:Description rdf:about="#Reaction_17">
    <dcterms:created>
      <rdf:Description>
        ...
        <ListOfConstants>
          <Constant key="Parameter_3781" name="k1" value="1.9"/>
        </ListOfConstants>
  ...
  <rdf:Description rdf:about="#Reaction_18">
    <dcterms:created>
      <rdf:Description>
        ...
        <ListOfConstants>
          <Constant key="Parameter_3780" name="Km" value="0.2"/>
          <Constant key="Parameter_3779" name="V" value="0.95"/>
        </ListOfConstants>
        <KineticLaw function="Function_8">
          <ListOfCallParameters>
            <CallParameter functionParameter="FunctionParameter_41">
  ...
  <rdf:Description rdf:about="#Reaction_19">
    <dcterms:created>
      <rdf:Description>
        ...
        <ListOfConstants>
          <Constant key="Parameter_3778" name="k1" value="1.3"/>
        </ListOfConstants>
        <KineticLaw function="Function_13">
          <ListOfCallParameters>
            <CallParameter functionParameter="FunctionParameter_81">
    ...
    <ListOfEvents>
      <Event key="Event_4" name="Maxima_Pn_SumN" delayAssignment="true" fireAtInitialTime="0" persistentTrigger="0">
        <MiriamAnnotation>
<rdf:RDF xmlns:dcterms="http://purl.org/dc/terms/" xmlns:rdf="http://www.w3.org/1999/02/22-rdf-syntax-ns#">
  <rdf:Description rdf:about="#Event_4">
    <dcterms:created>
      ...
      <Event key="Event_5" name="Maxima_Pn_1stMaxTime" fireAtInitialTime="0" persistentTrigger="0">
        <MiriamAnnotation>
<rdf:RDF xmlns:dcterms="http://purl.org/dc/terms/" xmlns:rdf="http://www.w3.org/1999/02/22-rdf-syntax-ns#">
  <rdf:Description rdf:about="#Event_5">
    <dcterms:created>
      ...
      <Event key="Event_6" name="Maxima_Pn_MaxTime" fireAtInitialTime="0" persistentTrigger="0">
        <MiriamAnnotation>
<rdf:RDF xmlns:dcterms="http://purl.org/dc/terms/" xmlns:rdf="http://www.w3.org/1999/02/22-rdf-syntax-ns#">
  <rdf:Description rdf:about="#Event_6">
    <dcterms:created>
      ...
      <Event key="Event_7" name="Tau" delayAssignment="true" fireAtInitialTime="0" persistentTrigger="0">
        <MiriamAnnotation>
<rdf:RDF xmlns:dcterms="http://purl.org/dc/terms/" xmlns:rdf="http://www.w3.org/1999/02/22-rdf-syntax-ns#">
  <rdf:Description rdf:about="#Event_7">
    ...
    <InitialState type="initialState">
      0 2.321994219789093e+17 3.672049640582935e+17 1.572457850832527e+18 7.303888790887313e+17 3.032719844043181e+17 2.711768182280298 0 1 0.76 1 0.65 0.5 0.38 2 3.2 2 1.58 2 5 2 2.5 1.9 1.3 0.95 0.2 4 0 1 0 0 
    </InitialState>
  </Model>
  <ListOfTasks>
    ...
    <Task key="Task_25" name="Time-Course" type="timeCourse" scheduled="false" updateModel="false">
      <Problem>
        <Parameter name="StepNumber" type="unsignedInteger" value="1679"/>
        <Parameter name="StepSize" type="float" value="0.0429082"/>
