...
<!-- generated with COPASI 4.16 (Build 104) (http://www.copasi.org) at 2017-01-09 11:16:09 UTC -->
...
<rdf:RDF
  ...
  <rdf:Description rdf:about="#ModelValue_18">
    <dcterms:created>
      ...
      <ModelValue key="ModelValue_19" name="periodMaxTime" simulationType="fixed">
        <MiriamAnnotation>
<rdf:RDF
   xmlns:dcterms="http://purl.org/dc/terms/"
   xmlns:rdf="http://www.w3.org/1999/02/22-rdf-syntax-ns#">
  <rdf:Description rdf:about="#ModelValue_19">
    <dcterms:created>
      ...
      <ModelValue key="ModelValue_20" name="periodSumN" simulationType="fixed">
        <MiriamAnnotation>
<rdf:RDF
   xmlns:dcterms="http://purl.org/dc/terms/"
   xmlns:rdf="http://www.w3.org/1999/02/22-rdf-syntax-ns#">
  <rdf:Description rdf:about="#ModelValue_20">
    <dcterms:created>
      ...
      <ModelValue key="ModelValue_21" name="period1stMaxTime" simulationType="fixed">
        <MiriamAnnotation>
<rdf:RDF
   xmlns:dcterms="http://purl.org/dc/terms/"
   xmlns:rdf="http://www.w3.org/1999/02/22-rdf-syntax-ns#">
  <rdf:Description rdf:about="#ModelValue_21">
    <dcterms:created>
      ...
      <ModelValue key="ModelValue_22" name="tau" simulationType="fixed">
        <MiriamAnnotation>
<rdf:RDF
   xmlns:dcterms="http://purl.org/dc/terms/"
   xmlns:rdf="http://www.w3.org/1999/02/22-rdf-syntax-ns#">
  <rdf:Description rdf:about="#ModelValue_22">
    <dcterms:created>
      ...
      <ModelValue key="ModelValue_23" name="tau_time_between" simulationType="assignment">
        <MiriamAnnotation>
<rdf:RDF
   xmlns:dcterms="http://purl.org/dc/terms/"
   xmlns:rdf="http://www.w3.org/1999/02/22-rdf-syntax-ns#">
  <rdf:Description rdf:about="#ModelValue_23">
    <dcterms:created>
      ...
      <ModelValue key="ModelValue_24" name="periodMaxValue" simulationType="fixed">
        <MiriamAnnotation>
<rdf:RDF
   xmlns:dcterms="http://purl.org/dc/terms/"
   xmlns:rdf="http://www.w3.org/1999/02/22-rdf-syntax-ns#">
  ...
  <rdf:Description rdf:about="#Event_1">
    <dcterms:created>
      <rdf:Description>
        ...
        <TriggerExpression>
          &lt;CN=Root,Model=New Model,Vector=Compartments[compartment],Vector=Metabolites[Pn],Reference=Rate&gt; &lt; 0 AND &lt;CN=Root,Model=New Model,Vector=Values[periodSumN],Reference=Value&gt; &lt;= 3 AND &lt;CN=Root,Model=New Model,Vector=Values[periodSumN],Reference=Value&gt; &gt; 2
        </TriggerExpression>
        <ListOfAssignments>
...
<rdf:RDF
  ...
  <rdf:Description rdf:about="#Event_2">
    <dcterms:created>
      ...
      <Event key="Event_3" name="Tau" delayAssignment="true" fireAtInitialTime="0" persistentTrigger="0">
        <MiriamAnnotation>
<rdf:RDF
   xmlns:dcterms="http://purl.org/dc/terms/"
   xmlns:rdf="http://www.w3.org/1999/02/22-rdf-syntax-ns#">
  <rdf:Description rdf:about="#Event_3">
    ...
    <ListOfModelParameterSets activeSet="ModelParameterSet_0">
      <ModelParameterSet key="ModelParameterSet_0" name="Initial State">
        <ModelParameterGroup cn="String=Initial Time" type="Group">
          <ModelParameter cn="CN=Root,Model=New Model" value="72.04286780000001" type="Model" simulationType="time"/>
        </ModelParameterGroup>
        <ModelParameterGroup cn="String=Initial Compartment Sizes" type="Group">
          <ModelParameter cn="CN=Root,Model=New Model,Vector=Compartments[compartment]" value="1" type="Compartment" simulationType="fixed"/>
        </ModelParameterGroup>
        <ModelParameterGroup cn="String=Initial Species Values" type="Group">
          <ModelParameter cn="CN=Root,Model=New Model,Vector=Compartments[compartment],Vector=Metabolites[M]" value="1.666860832267149e+18" type="Species" simulationType="reactions"/>
          <ModelParameter cn="CN=Root,Model=New Model,Vector=Compartments[compartment],Vector=Metabolites[P0]" value="8.282319884137819e+17" type="Species" simulationType="reactions"/>
          <ModelParameter cn="CN=Root,Model=New Model,Vector=Compartments[compartment],Vector=Metabolites[P1]" value="4.157857423248865e+17" type="Species" simulationType="reactions"/>
          <ModelParameter cn="CN=Root,Model=New Model,Vector=Compartments[compartment],Vector=Metabolites[P2]" value="2.735058438077543e+17" type="Species" simulationType="reactions"/>
          <ModelParameter cn="CN=Root,Model=New Model,Vector=Compartments[compartment],Vector=Metabolites[Pn]" value="3.572414817464253e+17" type="Species" simulationType="reactions"/>
        </ModelParameterGroup>
        <ModelParameterGroup cn="String=Initial Global Quantities" type="Group">
          <ModelParameter cn="CN=Root,Model=New Model,Vector=Values[vs]" value="1.9" type="ModelValue" simulationType="fixed"/>
          ...
          <ModelParameter cn="CN=Root,Model=New Model,Vector=Values[vd]" value="0.76" type="ModelValue" simulationType="fixed"/>
          <ModelParameter cn="CN=Root,Model=New Model,Vector=Values[Kd]" value="0.2" type="ModelValue" simulationType="fixed"/>
          <ModelParameter cn="CN=Root,Model=New Model,Vector=Values[TotalPer]" value="3.113120085292525" type="ModelValue" simulationType="assignment"/>
        ...
        <ModelParameterGroup cn="String=Kinetic Parameters" type="Group">
          <ModelParameterGroup cn="CN=Root,Model=New Model,Vector=Reactions[M_Make]" type="Reaction">
            <ModelParameter cn="CN=Root,Model=New Model,Vector=Reactions[M_Make],ParameterGroup=Parameters,Parameter=V" value="1.9" type="ReactionParameter" simulationType="assignment">
              <InitialExpression>
          ...
          <ModelParameterGroup cn="CN=Root,Model=New Model,Vector=Reactions[P2_Deg]" type="Reaction">
            ...
            <ModelParameter cn="CN=Root,Model=New Model,Vector=Reactions[P2_Deg],ParameterGroup=Parameters,Parameter=V" value="0.76" type="ReactionParameter" simulationType="assignment">
              <InitialExpression>
    ...
    <InitialState type="initialState">
      72.04286780000001 2.735058438077543e+17 4.157857423248865e+17 1.666860832267149e+18 8.282319884137819e+17 3.572414817464253e+17 3.113120085292525 0 1 1.9 1 0.65 0.5 0.38 2 3.2 2 1.58 2 5 2 2.5 1.9 1.3 0.76 0.2 4 0 0 0 0 0 
    </InitialState>
  </Model>
  <ListOfTasks>
      ...
      <Problem>
        ...
        <ParameterGroup name="ScanItems">
          <ParameterGroup name="ScanItem">
            ...
            <Parameter name="Maximum" type="float" value="1.4"/>
    ...
    <Task key="Task_8" name="Optimization" type="optimization" scheduled="false" updateModel="false">
      ...
      <Problem>
        ...
        <ParameterText name="ObjectiveExpression" type="expression">
          (((&lt;CN=Root,Model=New Model,Vector=Values[tau],Reference=Value&gt;-24.2)/24.2)^2)+(1/&lt;CN=Root,Model=New Model,Vector=Values[periodMaxValue],Reference=Value&gt;)
        </ParameterText>
